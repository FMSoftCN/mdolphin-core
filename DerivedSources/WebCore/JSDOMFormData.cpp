...
JSDOMFormDataConstructor::JSDOMFormDataConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMFormDataConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSDOMFormData::s_info = { "FormData", &DOMObjectWithGlobalPointer::s_info, &JSDOMFormDataTable, 0 };
...
{
    return new (exec) JSDOMFormDataPrototype(globalObject, JSDOMFormDataPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
