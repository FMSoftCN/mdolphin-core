...
public:
    JSSVGZoomEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGZoomEventConstructor::JSSVGZoomEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGZoomEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGZoomEventPrototype(globalObject, JSSVGZoomEventPrototype::createStructure(exec->globalData(), JSUIEventPrototype::self(exec, globalObject)));
}
