...
public:
    JSSVGClipPathElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGClipPathElementConstructor::JSSVGClipPathElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGClipPathElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGClipPathElementPrototype(globalObject, JSSVGClipPathElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
