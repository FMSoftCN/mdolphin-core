...
public:
    JSHTMLImageElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLImageElementConstructor::JSHTMLImageElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLImageElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLImageElementPrototype(globalObject, JSHTMLImageElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
