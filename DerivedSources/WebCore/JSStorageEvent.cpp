...
public:
    JSStorageEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSStorageEventConstructor::JSStorageEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSStorageEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSStorageEventPrototype(globalObject, JSStorageEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
