...
public:
    JSWebGLVertexArrayObjectOESConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLVertexArrayObjectOESConstructor::JSWebGLVertexArrayObjectOESConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLVertexArrayObjectOESConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLVertexArrayObjectOESConstructor, DOMObject>(exec, &JSWebGLVertexArrayObjectOESConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLVertexArrayObjectOESConstructor, DOMObject>(exec, &JSWebGLVertexArrayObjectOESConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLVertexArrayObjectOES::s_info = { "WebGLVertexArrayObjectOES", &DOMObjectWithGlobalPointer::s_info, &JSWebGLVertexArrayObjectOESTable, 0 };

JSWebGLVertexArrayObjectOES::JSWebGLVertexArrayObjectOES(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<WebGLVertexArrayObjectOES> impl)
...
{
    return new (exec) JSWebGLVertexArrayObjectOESPrototype(globalObject, JSWebGLVertexArrayObjectOESPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, WebGLVertexArrayObjectOES* object)
{
    return getDOMObjectWrapper<JSWebGLVertexArrayObjectOES>(exec, globalObject, object);
}
