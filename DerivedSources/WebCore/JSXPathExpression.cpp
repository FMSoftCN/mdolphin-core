...
JSXPathExpressionConstructor::JSXPathExpressionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXPathExpressionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXPathExpression::s_info = { "XPathExpression", &DOMObjectWithGlobalPointer::s_info, &JSXPathExpressionTable, 0 };
...
{
    return new (exec) JSXPathExpressionPrototype(globalObject, JSXPathExpressionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
