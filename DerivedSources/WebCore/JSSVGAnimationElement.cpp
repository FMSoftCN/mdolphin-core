...
{
    return new (exec) JSSVGAnimationElementPrototype(globalObject, JSSVGAnimationElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
