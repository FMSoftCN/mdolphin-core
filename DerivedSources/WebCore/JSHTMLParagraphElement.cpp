...
public:
    JSHTMLParagraphElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLParagraphElementConstructor::JSHTMLParagraphElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLParagraphElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLParagraphElementPrototype(globalObject, JSHTMLParagraphElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
