...
const ClassInfo JSBarInfo::s_info = { "BarInfo", &DOMObjectWithGlobalPointer::s_info, &JSBarInfoTable, 0 };
...
{
    return new (exec) JSBarInfoPrototype(globalObject, JSBarInfoPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
