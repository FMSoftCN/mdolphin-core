...
const ClassInfo JSVoidCallback::s_info = { "VoidCallback", &DOMObjectWithGlobalPointer::s_info, 0, 0 };
...
{
    return new (exec) JSVoidCallbackPrototype(globalObject, JSVoidCallbackPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
