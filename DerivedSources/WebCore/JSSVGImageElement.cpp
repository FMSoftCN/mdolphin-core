...
public:
    JSSVGImageElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGImageElementConstructor::JSSVGImageElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGImageElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGImageElementPrototype(globalObject, JSSVGImageElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
