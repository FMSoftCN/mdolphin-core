...
public:
    JSHTMLHeadElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLHeadElementConstructor::JSHTMLHeadElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLHeadElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLHeadElementPrototype(globalObject, JSHTMLHeadElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
