...
public:
    JSMessagePortConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSMessagePortConstructor::JSMessagePortConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSMessagePortConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSMessagePort::s_info = { "MessagePort", &DOMObjectWithGlobalPointer::s_info, 0, getJSMessagePortTable };
...
{
    return new (exec) JSMessagePortPrototype(globalObject, JSMessagePortPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
