...
public:
    JSXMLSerializerConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSXMLSerializerConstructor::JSXMLSerializerConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXMLSerializerConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXMLSerializer::s_info = { "XMLSerializer", &DOMObjectWithGlobalPointer::s_info, &JSXMLSerializerTable, 0 };
...
{
    return new (exec) JSXMLSerializerPrototype(globalObject, JSXMLSerializerPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
