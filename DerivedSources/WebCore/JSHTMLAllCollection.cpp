...
public:
    JSHTMLAllCollectionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLAllCollectionConstructor::JSHTMLAllCollectionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLAllCollectionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSHTMLAllCollection::s_info = { "HTMLAllCollection", &DOMObjectWithGlobalPointer::s_info, &JSHTMLAllCollectionTable, 0 };
...
{
    return new (exec) JSHTMLAllCollectionPrototype(globalObject, JSHTMLAllCollectionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
