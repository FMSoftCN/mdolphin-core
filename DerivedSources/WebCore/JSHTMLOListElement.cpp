...
public:
    JSHTMLOListElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLOListElementConstructor::JSHTMLOListElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLOListElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLOListElementPrototype(globalObject, JSHTMLOListElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
