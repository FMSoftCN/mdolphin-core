...
public:
    JSEntryConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSEntryConstructor::JSEntryConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEntryConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSEntryConstructor, DOMObject>(exec, &JSEntryConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSEntryConstructor, DOMObject>(exec, &JSEntryConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSEntry::s_info = { "Entry", &DOMObjectWithGlobalPointer::s_info, 0, getJSEntryTable };

JSEntry::JSEntry(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<Entry> impl)
...
{
    return new (exec) JSEntryPrototype(globalObject, JSEntryPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
