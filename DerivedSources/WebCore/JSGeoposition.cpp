...
const ClassInfo JSGeoposition::s_info = { "Geoposition", &DOMObjectWithGlobalPointer::s_info, &JSGeopositionTable, 0 };
...
{
    return new (exec) JSGeopositionPrototype(globalObject, JSGeopositionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
