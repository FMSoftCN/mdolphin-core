...
public:
    JSCanvasRenderingContext2DConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCanvasRenderingContext2DConstructor::JSCanvasRenderingContext2DConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCanvasRenderingContext2DConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCanvasRenderingContext2DPrototype(globalObject, JSCanvasRenderingContext2DPrototype::createStructure(exec->globalData(), JSCanvasRenderingContextPrototype::self(exec, globalObject)));
}
