...
const ClassInfo JSWorkerNavigator::s_info = { "WorkerNavigator", &DOMObjectWithGlobalPointer::s_info, 0, getJSWorkerNavigatorTable };
...
{
    return new (exec) JSWorkerNavigatorPrototype(globalObject, JSWorkerNavigatorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
