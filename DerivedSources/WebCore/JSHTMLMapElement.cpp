...
public:
    JSHTMLMapElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLMapElementConstructor::JSHTMLMapElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLMapElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLMapElementPrototype(globalObject, JSHTMLMapElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
