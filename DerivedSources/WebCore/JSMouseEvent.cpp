...
public:
    JSMouseEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSMouseEventConstructor::JSMouseEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSMouseEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSMouseEventPrototype(globalObject, JSMouseEventPrototype::createStructure(exec->globalData(), JSUIEventPrototype::self(exec, globalObject)));
}
