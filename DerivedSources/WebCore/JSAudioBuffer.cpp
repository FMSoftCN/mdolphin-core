...
public:
    JSAudioBufferConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioBufferConstructor::JSAudioBufferConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioBufferConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioBufferConstructor, DOMObject>(exec, &JSAudioBufferConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioBufferConstructor, DOMObject>(exec, &JSAudioBufferConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSAudioBuffer::s_info = { "AudioBuffer", &DOMObjectWithGlobalPointer::s_info, &JSAudioBufferTable, 0 };

JSAudioBuffer::JSAudioBuffer(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioBuffer> impl)
...
{
    return new (exec) JSAudioBufferPrototype(globalObject, JSAudioBufferPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioBuffer* object)
{
    return getDOMObjectWrapper<JSAudioBuffer>(exec, globalObject, object);
}
