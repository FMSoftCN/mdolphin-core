...
public:
    JSDirectoryReaderSyncConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDirectoryReaderSyncConstructor::JSDirectoryReaderSyncConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDirectoryReaderSyncConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDirectoryReaderSyncConstructor, DOMObject>(exec, &JSDirectoryReaderSyncConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDirectoryReaderSyncConstructor, DOMObject>(exec, &JSDirectoryReaderSyncConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDirectoryReaderSync::s_info = { "DirectoryReaderSync", &DOMObjectWithGlobalPointer::s_info, 0, getJSDirectoryReaderSyncTable };

JSDirectoryReaderSync::JSDirectoryReaderSync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DirectoryReaderSync> impl)
...
{
    return new (exec) JSDirectoryReaderSyncPrototype(globalObject, JSDirectoryReaderSyncPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DirectoryReaderSync* object)
{
    return getDOMObjectWrapper<JSDirectoryReaderSync>(exec, globalObject, object);
}
