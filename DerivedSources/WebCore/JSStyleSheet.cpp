...
public:
    JSStyleSheetConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSStyleSheetConstructor::JSStyleSheetConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSStyleSheetConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSStyleSheet::s_info = { "StyleSheet", &DOMObjectWithGlobalPointer::s_info, &JSStyleSheetTable, 0 };
...
{
    return new (exec) JSStyleSheetPrototype(globalObject, JSStyleSheetPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
