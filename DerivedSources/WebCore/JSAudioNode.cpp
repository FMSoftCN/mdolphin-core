...
public:
    JSAudioNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioNodeConstructor::JSAudioNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioNodeConstructor, DOMObject>(exec, &JSAudioNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioNodeConstructor, DOMObject>(exec, &JSAudioNodeConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSAudioNode::s_info = { "AudioNode", &DOMObjectWithGlobalPointer::s_info, &JSAudioNodeTable, 0 };

JSAudioNode::JSAudioNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioNode> impl)
...
{
    return new (exec) JSAudioNodePrototype(globalObject, JSAudioNodePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioNode* object)
{
    return getDOMObjectWrapper<JSAudioNode>(exec, globalObject, object);
}
