...
public:
    JSWebGLRenderingContextConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLRenderingContextConstructor::JSWebGLRenderingContextConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLRenderingContextConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSWebGLRenderingContextPrototype(globalObject, JSWebGLRenderingContextPrototype::createStructure(exec->globalData(), JSCanvasRenderingContextPrototype::self(exec, globalObject)));
}
