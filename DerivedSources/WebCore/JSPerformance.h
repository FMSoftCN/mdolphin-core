...
class JSPerformance : public DOMObjectWithGlobalPointer {
    typedef DOMObjectWithGlobalPointer Base;
public:
    JSPerformance(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<Performance>);
...
public:
    ...
    JSPerformancePrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
