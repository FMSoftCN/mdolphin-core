...
const ClassInfo JSScreen::s_info = { "Screen", &DOMObjectWithGlobalPointer::s_info, &JSScreenTable, 0 };
...
{
    return new (exec) JSScreenPrototype(globalObject, JSScreenPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
