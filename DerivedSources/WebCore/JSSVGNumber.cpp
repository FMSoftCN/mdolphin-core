...
JSSVGNumberConstructor::JSSVGNumberConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGNumberConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGNumber::s_info = { "SVGNumber", &DOMObjectWithGlobalPointer::s_info, &JSSVGNumberTable, 0 };

JSSVGNumber::JSSVGNumber(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPropertyTearOff<float> > impl)
...
{
    return new (exec) JSSVGNumberPrototype(globalObject, JSSVGNumberPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPropertyTearOff<float> * object)
{
    return getDOMObjectWrapper<JSSVGNumber, SVGPropertyTearOff<float> >(exec, globalObject, object);
}
