...
class JSPerformanceTiming : public DOMObjectWithGlobalPointer {
    typedef DOMObjectWithGlobalPointer Base;
public:
    JSPerformanceTiming(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<PerformanceTiming>);
...
public:
    ...
    JSPerformanceTimingPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
