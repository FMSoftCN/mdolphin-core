...
const ClassInfo JSGeolocation::s_info = { "Geolocation", &DOMObjectWithGlobalPointer::s_info, 0, 0 };
...
{
    return new (exec) JSGeolocationPrototype(globalObject, JSGeolocationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
