...
public:
    JSHTMLFrameSetElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLFrameSetElementConstructor::JSHTMLFrameSetElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLFrameSetElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLFrameSetElementPrototype(globalObject, JSHTMLFrameSetElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
