...
public:
    JSDOMFileSystemConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDOMFileSystemConstructor::JSDOMFileSystemConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMFileSystemConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDOMFileSystemConstructor, DOMObject>(exec, &JSDOMFileSystemConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDOMFileSystemConstructor, DOMObject>(exec, &JSDOMFileSystemConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDOMFileSystem::s_info = { "DOMFileSystem", &DOMObjectWithGlobalPointer::s_info, 0, getJSDOMFileSystemTable };

JSDOMFileSystem::JSDOMFileSystem(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DOMFileSystem> impl)
...
{
    return new (exec) JSDOMFileSystemPrototype(globalObject, JSDOMFileSystemPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DOMFileSystem* object)
{
    return getDOMObjectWrapper<JSDOMFileSystem>(exec, globalObject, object);
}
