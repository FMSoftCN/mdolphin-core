...
public:
    JSCounterConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCounterConstructor::JSCounterConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCounterConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCounter::s_info = { "Counter", &DOMObjectWithGlobalPointer::s_info, &JSCounterTable, 0 };
...
{
    return new (exec) JSCounterPrototype(globalObject, JSCounterPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
