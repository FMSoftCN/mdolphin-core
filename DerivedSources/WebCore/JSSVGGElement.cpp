...
public:
    JSSVGGElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGGElementConstructor::JSSVGGElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGGElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGGElementPrototype(globalObject, JSSVGGElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
