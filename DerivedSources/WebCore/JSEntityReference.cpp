...
public:
    JSEntityReferenceConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSEntityReferenceConstructor::JSEntityReferenceConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEntityReferenceConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSEntityReferencePrototype(globalObject, JSEntityReferencePrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
