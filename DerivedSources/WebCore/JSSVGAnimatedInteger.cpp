...
public:
    JSSVGAnimatedIntegerConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedIntegerConstructor::JSSVGAnimatedIntegerConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedIntegerConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedInteger::s_info = { "SVGAnimatedInteger", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedIntegerTable, 0 };
...
{
    return new (exec) JSSVGAnimatedIntegerPrototype(globalObject, JSSVGAnimatedIntegerPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedInteger* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedInteger>(exec, globalObject, object);
}
