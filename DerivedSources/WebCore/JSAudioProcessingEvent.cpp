...
public:
    JSAudioProcessingEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioProcessingEventConstructor::JSAudioProcessingEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioProcessingEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioProcessingEventConstructor, DOMObject>(exec, &JSAudioProcessingEventConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioProcessingEventConstructor, DOMObject>(exec, &JSAudioProcessingEventConstructorTable, this, propertyName, descriptor);
}
...
JSAudioProcessingEvent::JSAudioProcessingEvent(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioProcessingEvent> impl)
...
{
    return new (exec) JSAudioProcessingEventPrototype(globalObject, JSAudioProcessingEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioProcessingEvent* object)
{
    return getDOMObjectWrapper<JSAudioProcessingEvent>(exec, globalObject, object);
}
