...
public:
    JSRangeExceptionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSRangeExceptionConstructor::JSRangeExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSRangeExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSRangeException::s_info = { "RangeException", &DOMObjectWithGlobalPointer::s_info, &JSRangeExceptionTable, 0 };
...
{
    return new (exec) JSRangeExceptionPrototype(globalObject, JSRangeExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
