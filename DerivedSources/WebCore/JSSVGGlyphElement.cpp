...
public:
    JSSVGGlyphElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGGlyphElementConstructor::JSSVGGlyphElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGGlyphElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGGlyphElementPrototype(globalObject, JSSVGGlyphElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
