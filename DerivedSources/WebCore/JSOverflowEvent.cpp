...
public:
    JSOverflowEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSOverflowEventConstructor::JSOverflowEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSOverflowEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSOverflowEventPrototype(globalObject, JSOverflowEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
