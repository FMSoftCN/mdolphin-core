...
JSSVGPathSegListConstructor::JSSVGPathSegListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGPathSegList::s_info = { "SVGPathSegList", &DOMObjectWithGlobalPointer::s_info, &JSSVGPathSegListTable, 0 };

JSSVGPathSegList::JSSVGPathSegList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPathSegListPropertyTearOff > impl)
...
{
    return new (exec) JSSVGPathSegListPrototype(globalObject, JSSVGPathSegListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPathSegListPropertyTearOff * object)
{
    return getDOMObjectWrapper<JSSVGPathSegList>(exec, globalObject, object);
}
