...
public:
    JSSVGTRefElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGTRefElementConstructor::JSSVGTRefElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTRefElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGTRefElementPrototype(globalObject, JSSVGTRefElementPrototype::createStructure(exec->globalData(), JSSVGTextPositioningElementPrototype::self(exec, globalObject)));
}
