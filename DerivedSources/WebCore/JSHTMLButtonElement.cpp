...
public:
    JSHTMLButtonElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLButtonElementConstructor::JSHTMLButtonElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLButtonElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLButtonElementPrototype(globalObject, JSHTMLButtonElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
