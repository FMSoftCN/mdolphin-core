...
public:
    JSHashChangeEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHashChangeEventConstructor::JSHashChangeEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHashChangeEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSHashChangeEventConstructor, DOMObject>(exec, &JSHashChangeEventConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHashChangeEventConstructor, DOMObject>(exec, &JSHashChangeEventConstructorTable, this, propertyName, descriptor);
}
...
JSHashChangeEvent::JSHashChangeEvent(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<HashChangeEvent> impl)
...
{
    return new (exec) JSHashChangeEventPrototype(globalObject, JSHashChangeEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
