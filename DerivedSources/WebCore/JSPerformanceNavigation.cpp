...
const ClassInfo JSPerformanceNavigation::s_info = { "PerformanceNavigation", &DOMObjectWithGlobalPointer::s_info, &JSPerformanceNavigationTable, 0 };

JSPerformanceNavigation::JSPerformanceNavigation(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<PerformanceNavigation> impl)
...
{
    return new (exec) JSPerformanceNavigationPrototype(globalObject, JSPerformanceNavigationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, PerformanceNavigation* object)
{
    return getDOMObjectWrapper<JSPerformanceNavigation>(exec, globalObject, object);
}
