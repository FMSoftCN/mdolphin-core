...
JSEventSourceConstructor::JSEventSourceConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEventSourceConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSEventSource::s_info = { "EventSource", &DOMObjectWithGlobalPointer::s_info, 0, getJSEventSourceTable };
...
{
    return new (exec) JSEventSourcePrototype(globalObject, JSEventSourcePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
