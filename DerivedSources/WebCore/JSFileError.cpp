...
JSFileErrorConstructor::JSFileErrorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileErrorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSFileError::s_info = { "FileError", &DOMObjectWithGlobalPointer::s_info, 0, getJSFileErrorTable };
...
{
    return new (exec) JSFileErrorPrototype(globalObject, JSFileErrorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
