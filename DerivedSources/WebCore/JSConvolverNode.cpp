...
public:
    JSConvolverNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSConvolverNodeConstructor::JSConvolverNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSConvolverNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSConvolverNodeConstructor, DOMObject>(exec, &JSConvolverNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSConvolverNodeConstructor, DOMObject>(exec, &JSConvolverNodeConstructorTable, this, propertyName, descriptor);
}
...
JSConvolverNode::JSConvolverNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<ConvolverNode> impl)
...
{
    return new (exec) JSConvolverNodePrototype(globalObject, JSConvolverNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, ConvolverNode* object)
{
    return getDOMObjectWrapper<JSConvolverNode>(exec, globalObject, object);
}
