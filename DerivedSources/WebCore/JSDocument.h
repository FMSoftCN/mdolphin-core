...
JSC::EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionResetWMLPageState(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionInitializeWMLPageState(JSC::ExecState*);
