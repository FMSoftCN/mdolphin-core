...
public:
    JSSVGHKernElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGHKernElementConstructor::JSSVGHKernElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGHKernElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGHKernElementPrototype(globalObject, JSSVGHKernElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
