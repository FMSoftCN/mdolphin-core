...
public:
    JSHTMLQuoteElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLQuoteElementConstructor::JSHTMLQuoteElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLQuoteElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLQuoteElementPrototype(globalObject, JSHTMLQuoteElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
