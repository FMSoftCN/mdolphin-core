...
public:
    JSSVGFontElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFontElementConstructor::JSSVGFontElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFontElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFontElementPrototype(globalObject, JSSVGFontElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
