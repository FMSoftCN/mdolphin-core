...
public:
    JSXMLHttpRequestExceptionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSXMLHttpRequestExceptionConstructor::JSXMLHttpRequestExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXMLHttpRequestExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXMLHttpRequestException::s_info = { "XMLHttpRequestException", &DOMObjectWithGlobalPointer::s_info, 0, getJSXMLHttpRequestExceptionTable };
...
{
    return new (exec) JSXMLHttpRequestExceptionPrototype(globalObject, JSXMLHttpRequestExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
