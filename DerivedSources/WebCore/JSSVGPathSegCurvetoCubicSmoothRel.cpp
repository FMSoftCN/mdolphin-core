...
public:
    JSSVGPathSegCurvetoCubicSmoothRelConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegCurvetoCubicSmoothRelConstructor::JSSVGPathSegCurvetoCubicSmoothRelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegCurvetoCubicSmoothRelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegCurvetoCubicSmoothRelPrototype(globalObject, JSSVGPathSegCurvetoCubicSmoothRelPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
