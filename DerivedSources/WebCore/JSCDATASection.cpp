...
public:
    JSCDATASectionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCDATASectionConstructor::JSCDATASectionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCDATASectionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCDATASectionPrototype(globalObject, JSCDATASectionPrototype::createStructure(exec->globalData(), JSTextPrototype::self(exec, globalObject)));
}
