...
public:
    JSEntityConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSEntityConstructor::JSEntityConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEntityConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSEntityPrototype(globalObject, JSEntityPrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
