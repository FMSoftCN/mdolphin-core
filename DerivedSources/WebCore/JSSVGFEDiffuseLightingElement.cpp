...
public:
    JSSVGFEDiffuseLightingElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEDiffuseLightingElementConstructor::JSSVGFEDiffuseLightingElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEDiffuseLightingElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEDiffuseLightingElementPrototype(globalObject, JSSVGFEDiffuseLightingElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
