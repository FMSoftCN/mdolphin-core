...
class JSOESStandardDerivatives : public DOMObjectWithGlobalPointer {
    typedef DOMObjectWithGlobalPointer Base;
public:
    JSOESStandardDerivatives(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<OESStandardDerivatives>);
...
public:
    ...
    JSOESStandardDerivativesPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
