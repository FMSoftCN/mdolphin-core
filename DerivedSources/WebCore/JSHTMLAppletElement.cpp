...
public:
    JSHTMLAppletElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLAppletElementConstructor::JSHTMLAppletElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLAppletElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLAppletElementPrototype(globalObject, JSHTMLAppletElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
