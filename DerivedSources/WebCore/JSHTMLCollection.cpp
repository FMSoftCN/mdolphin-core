...
JSHTMLCollectionConstructor::JSHTMLCollectionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLCollectionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSHTMLCollection::s_info = { "HTMLCollection", &DOMObjectWithGlobalPointer::s_info, &JSHTMLCollectionTable, 0 };
...
{
    return new (exec) JSHTMLCollectionPrototype(globalObject, JSHTMLCollectionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
