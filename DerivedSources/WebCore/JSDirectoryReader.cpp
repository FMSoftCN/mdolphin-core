...
public:
    JSDirectoryReaderConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDirectoryReaderConstructor::JSDirectoryReaderConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDirectoryReaderConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDirectoryReaderConstructor, DOMObject>(exec, &JSDirectoryReaderConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDirectoryReaderConstructor, DOMObject>(exec, &JSDirectoryReaderConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDirectoryReader::s_info = { "DirectoryReader", &DOMObjectWithGlobalPointer::s_info, 0, getJSDirectoryReaderTable };

JSDirectoryReader::JSDirectoryReader(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DirectoryReader> impl)
...
{
    return new (exec) JSDirectoryReaderPrototype(globalObject, JSDirectoryReaderPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DirectoryReader* object)
{
    return getDOMObjectWrapper<JSDirectoryReader>(exec, globalObject, object);
}
