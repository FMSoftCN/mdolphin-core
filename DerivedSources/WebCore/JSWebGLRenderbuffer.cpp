...
public:
    JSWebGLRenderbufferConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLRenderbufferConstructor::JSWebGLRenderbufferConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLRenderbufferConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLRenderbufferConstructor, DOMObject>(exec, &JSWebGLRenderbufferConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLRenderbufferConstructor, DOMObject>(exec, &JSWebGLRenderbufferConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLRenderbuffer::s_info = { "WebGLRenderbuffer", &DOMObjectWithGlobalPointer::s_info, &JSWebGLRenderbufferTable, 0 };
...
{
    return new (exec) JSWebGLRenderbufferPrototype(globalObject, JSWebGLRenderbufferPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
