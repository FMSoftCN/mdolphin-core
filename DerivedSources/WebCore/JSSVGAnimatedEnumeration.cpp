...
public:
    JSSVGAnimatedEnumerationConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedEnumerationConstructor::JSSVGAnimatedEnumerationConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedEnumerationConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedEnumeration::s_info = { "SVGAnimatedEnumeration", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedEnumerationTable, 0 };
...
{
    return new (exec) JSSVGAnimatedEnumerationPrototype(globalObject, JSSVGAnimatedEnumerationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedEnumeration* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedEnumeration>(exec, globalObject, object);
}
