...
public:
    JSSVGExceptionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGExceptionConstructor::JSSVGExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGException::s_info = { "SVGException", &DOMObjectWithGlobalPointer::s_info, &JSSVGExceptionTable, 0 };
...
{
    return new (exec) JSSVGExceptionPrototype(globalObject, JSSVGExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGException* object)
{
    return getDOMObjectWrapper<JSSVGException>(exec, globalObject, object);
}
