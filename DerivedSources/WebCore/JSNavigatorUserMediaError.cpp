...
public:
    JSNavigatorUserMediaErrorConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSNavigatorUserMediaErrorConstructor::JSNavigatorUserMediaErrorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSNavigatorUserMediaErrorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSNavigatorUserMediaErrorConstructor, DOMObject>(exec, &JSNavigatorUserMediaErrorConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSNavigatorUserMediaErrorConstructor, DOMObject>(exec, &JSNavigatorUserMediaErrorConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSNavigatorUserMediaError::s_info = { "NavigatorUserMediaError", &DOMObjectWithGlobalPointer::s_info, &JSNavigatorUserMediaErrorTable, 0 };

JSNavigatorUserMediaError::JSNavigatorUserMediaError(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<NavigatorUserMediaError> impl)
...
{
    return new (exec) JSNavigatorUserMediaErrorPrototype(globalObject, JSNavigatorUserMediaErrorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, NavigatorUserMediaError* object)
{
    return getDOMObjectWrapper<JSNavigatorUserMediaError>(exec, globalObject, object);
}
