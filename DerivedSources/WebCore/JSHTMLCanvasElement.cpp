...
public:
    JSHTMLCanvasElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLCanvasElementConstructor::JSHTMLCanvasElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLCanvasElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLCanvasElementPrototype(globalObject, JSHTMLCanvasElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
