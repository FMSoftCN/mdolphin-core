...
public:
    JSTextMetricsConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSTextMetricsConstructor::JSTextMetricsConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTextMetricsConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSTextMetrics::s_info = { "TextMetrics", &DOMObjectWithGlobalPointer::s_info, &JSTextMetricsTable, 0 };
...
{
    return new (exec) JSTextMetricsPrototype(globalObject, JSTextMetricsPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
