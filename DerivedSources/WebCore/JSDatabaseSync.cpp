...
const ClassInfo JSDatabaseSync::s_info = { "DatabaseSync", &DOMObjectWithGlobalPointer::s_info, 0, getJSDatabaseSyncTable };
...
{
    return new (exec) JSDatabaseSyncPrototype(globalObject, JSDatabaseSyncPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
