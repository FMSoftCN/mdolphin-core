...
public:
    JSWebGLBufferConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLBufferConstructor::JSWebGLBufferConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLBufferConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLBufferConstructor, DOMObject>(exec, &JSWebGLBufferConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLBufferConstructor, DOMObject>(exec, &JSWebGLBufferConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLBuffer::s_info = { "WebGLBuffer", &DOMObjectWithGlobalPointer::s_info, &JSWebGLBufferTable, 0 };
...
{
    return new (exec) JSWebGLBufferPrototype(globalObject, JSWebGLBufferPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
