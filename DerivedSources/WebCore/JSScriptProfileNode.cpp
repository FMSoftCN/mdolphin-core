...
const ClassInfo JSScriptProfileNode::s_info = { "ScriptProfileNode", &DOMObjectWithGlobalPointer::s_info, &JSScriptProfileNodeTable, 0 };

JSScriptProfileNode::JSScriptProfileNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<ScriptProfileNode> impl)
...
{
    return new (exec) JSScriptProfileNodePrototype(globalObject, JSScriptProfileNodePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, ScriptProfileNode* object)
{
    return getDOMObjectWrapper<JSScriptProfileNode>(exec, globalObject, object);
}
