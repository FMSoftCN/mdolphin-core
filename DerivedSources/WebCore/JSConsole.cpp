...
const ClassInfo JSConsole::s_info = { "Console", &DOMObjectWithGlobalPointer::s_info, &JSConsoleTable, 0 };
...
{
    return new (exec) JSConsolePrototype(globalObject, JSConsolePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
