...
public:
    JSFileEntryConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSFileEntryConstructor::JSFileEntryConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileEntryConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSFileEntryConstructor, DOMObject>(exec, &JSFileEntryConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSFileEntryConstructor, DOMObject>(exec, &JSFileEntryConstructorTable, this, propertyName, descriptor);
}
...
JSFileEntry::JSFileEntry(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<FileEntry> impl)
...
{
    return new (exec) JSFileEntryPrototype(globalObject, JSFileEntryPrototype::createStructure(exec->globalData(), JSEntryPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, FileEntry* object)
{
    return getDOMObjectWrapper<JSFileEntry>(exec, globalObject, object);
}
