...
public:
    JSAttrConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAttrConstructor::JSAttrConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAttrConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSAttrPrototype(globalObject, JSAttrPrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
