...
JSPositionErrorConstructor::JSPositionErrorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSPositionErrorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSPositionError::s_info = { "PositionError", &DOMObjectWithGlobalPointer::s_info, &JSPositionErrorTable, 0 };
...
{
    return new (exec) JSPositionErrorPrototype(globalObject, JSPositionErrorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
