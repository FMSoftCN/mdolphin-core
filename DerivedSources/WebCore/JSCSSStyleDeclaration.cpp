...
JSCSSStyleDeclarationConstructor::JSCSSStyleDeclarationConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSStyleDeclarationConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCSSStyleDeclaration::s_info = { "CSSStyleDeclaration", &DOMObjectWithGlobalPointer::s_info, &JSCSSStyleDeclarationTable, 0 };
...
{
    return new (exec) JSCSSStyleDeclarationPrototype(globalObject, JSCSSStyleDeclarationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
