...
JSSVGLengthListConstructor::JSSVGLengthListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGLengthListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGLengthList::s_info = { "SVGLengthList", &DOMObjectWithGlobalPointer::s_info, &JSSVGLengthListTable, 0 };

JSSVGLengthList::JSSVGLengthList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGListPropertyTearOff<SVGLengthList> > impl)
...
{
    return new (exec) JSSVGLengthListPrototype(globalObject, JSSVGLengthListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGListPropertyTearOff<SVGLengthList> * object)
{
    return getDOMObjectWrapper<JSSVGLengthList>(exec, globalObject, object);
}
