...
JSSVGRadialGradientElementConstructor::JSSVGRadialGradientElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGRadialGradientElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGRadialGradientElementPrototype(globalObject, JSSVGRadialGradientElementPrototype::createStructure(exec->globalData(), JSSVGGradientElementPrototype::self(exec, globalObject)));
}
