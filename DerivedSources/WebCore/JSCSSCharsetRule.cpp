...
public:
    JSCSSCharsetRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSCharsetRuleConstructor::JSCSSCharsetRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSCharsetRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCSSCharsetRulePrototype(globalObject, JSCSSCharsetRulePrototype::createStructure(exec->globalData(), JSCSSRulePrototype::self(exec, globalObject)));
}
