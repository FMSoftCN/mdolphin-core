...
public:
    JSSVGMissingGlyphElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGMissingGlyphElementConstructor::JSSVGMissingGlyphElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGMissingGlyphElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGMissingGlyphElementPrototype(globalObject, JSSVGMissingGlyphElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
