...
public:
    JSHTMLUListElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLUListElementConstructor::JSHTMLUListElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLUListElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLUListElementPrototype(globalObject, JSHTMLUListElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
