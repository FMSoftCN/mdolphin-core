...
public:
    JSDataTransferItemConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDataTransferItemConstructor::JSDataTransferItemConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDataTransferItemConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDataTransferItemConstructor, DOMObject>(exec, &JSDataTransferItemConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDataTransferItemConstructor, DOMObject>(exec, &JSDataTransferItemConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDataTransferItem::s_info = { "DataTransferItem", &DOMObjectWithGlobalPointer::s_info, &JSDataTransferItemTable, 0 };

JSDataTransferItem::JSDataTransferItem(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DataTransferItem> impl)
...
{
    return new (exec) JSDataTransferItemPrototype(globalObject, JSDataTransferItemPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DataTransferItem* object)
{
    return getDOMObjectWrapper<JSDataTransferItem>(exec, globalObject, object);
}
