...
public:
    JSTreeWalkerConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSTreeWalkerConstructor::JSTreeWalkerConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTreeWalkerConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSTreeWalker::s_info = { "TreeWalker", &DOMObjectWithGlobalPointer::s_info, &JSTreeWalkerTable, 0 };
...
{
    return new (exec) JSTreeWalkerPrototype(globalObject, JSTreeWalkerPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
