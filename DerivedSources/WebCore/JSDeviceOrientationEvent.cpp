...
JSDeviceOrientationEventConstructor::JSDeviceOrientationEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDeviceOrientationEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSDeviceOrientationEventPrototype(globalObject, JSDeviceOrientationEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
