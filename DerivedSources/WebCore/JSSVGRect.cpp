...
public:
    JSSVGRectConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGRectConstructor::JSSVGRectConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGRectConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGRect::s_info = { "SVGRect", &DOMObjectWithGlobalPointer::s_info, &JSSVGRectTable, 0 };

JSSVGRect::JSSVGRect(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPropertyTearOff<FloatRect> > impl)
...
{
    return new (exec) JSSVGRectPrototype(globalObject, JSSVGRectPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPropertyTearOff<FloatRect> * object)
{
    return getDOMObjectWrapper<JSSVGRect, SVGPropertyTearOff<FloatRect> >(exec, globalObject, object);
}
