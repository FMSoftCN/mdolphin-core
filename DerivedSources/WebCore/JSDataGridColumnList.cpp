...
{
    { "length", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDataGridColumnListLength), (intptr_t)0 THUNK_GENERATOR(0) },
    { "sortColumn", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDataGridColumnListSortColumn), (intptr_t)0 THUNK_GENERATOR(0) },
    { "primaryColumn", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDataGridColumnListPrimaryColumn), (intptr_t)0 THUNK_GENERATOR(0) },
    { "constructor", DontEnum | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDataGridColumnListConstructor), (intptr_t)0 THUNK_GENERATOR(0) },
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};

#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSDataGridColumnListTable = { 10, 7, JSDataGridColumnListTableValues, 0 };
...
#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSDataGridColumnListConstructorTable = { 1, 0, JSDataGridColumnListConstructorTableValues, 0 };
class JSDataGridColumnListConstructor : public DOMConstructorObject {
public:
    JSDataGridColumnListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
const ClassInfo JSDataGridColumnListConstructor::s_info = { "DataGridColumnListConstructor", &DOMConstructorObject::s_info, &JSDataGridColumnListConstructorTable, 0 };

JSDataGridColumnListConstructor::JSDataGridColumnListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDataGridColumnListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
    ASSERT(inherits(&s_info));
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSDataGridColumnListPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
{
    { "item", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDataGridColumnListPrototypeFunctionItem), (intptr_t)1 THUNK_GENERATOR(0) },
    { "add", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDataGridColumnListPrototypeFunctionAdd), (intptr_t)5 THUNK_GENERATOR(0) },
    { "remove", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDataGridColumnListPrototypeFunctionRemove), (intptr_t)1 THUNK_GENERATOR(0) },
    { "move", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDataGridColumnListPrototypeFunctionMove), (intptr_t)2 THUNK_GENERATOR(0) },
    { "clear", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDataGridColumnListPrototypeFunctionClear), (intptr_t)0 THUNK_GENERATOR(0) },
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};

#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSDataGridColumnListPrototypeTable = { 17, 15, JSDataGridColumnListPrototypeTableValues, 0 };
const ClassInfo JSDataGridColumnListPrototype::s_info = { "DataGridColumnListPrototype", &JSC::JSObjectWithGlobalObject::s_info, &JSDataGridColumnListPrototypeTable, 0 };
...
const ClassInfo JSDataGridColumnList::s_info = { "DataGridColumnList", &DOMObjectWithGlobalPointer::s_info, &JSDataGridColumnListTable, 0 };
...
{
    return new (exec) JSDataGridColumnListPrototype(globalObject, JSDataGridColumnListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
EncodedJSValue JSC_HOST_CALL jsDataGridColumnListPrototypeFunctionItem(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDataGridColumnList::s_info))
        return throwVMTypeError(exec);
    JSDataGridColumnList* castedThis = static_cast<JSDataGridColumnList*>(asObject(thisValue));
    DataGridColumnList* imp = static_cast<DataGridColumnList*>(castedThis->impl());
...
EncodedJSValue JSC_HOST_CALL jsDataGridColumnListPrototypeFunctionAdd(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDataGridColumnList::s_info))
        return throwVMTypeError(exec);
    JSDataGridColumnList* castedThis = static_cast<JSDataGridColumnList*>(asObject(thisValue));
    DataGridColumnList* imp = static_cast<DataGridColumnList*>(castedThis->impl());
    const String& id(ustringToString(exec->argument(0).toString(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& label(ustringToString(exec->argument(1).toString(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    const String& type(ustringToString(exec->argument(2).toString(exec)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    bool primary(exec->argument(3).toBoolean(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
    unsigned short sortable(exec->argument(4).toUInt32(exec));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());


    JSC::JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(imp->add(id, label, type, primary, sortable)));
    return JSValue::encode(result);
}

EncodedJSValue JSC_HOST_CALL jsDataGridColumnListPrototypeFunctionRemove(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDataGridColumnList::s_info))
        return throwVMTypeError(exec);
    JSDataGridColumnList* castedThis = static_cast<JSDataGridColumnList*>(asObject(thisValue));
    DataGridColumnList* imp = static_cast<DataGridColumnList*>(castedThis->impl());
    DataGridColumn* column(toDataGridColumn(exec->argument(0)));
    if (exec->hadException())
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsDataGridColumnListPrototypeFunctionMove(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDataGridColumnList::s_info))
        return throwVMTypeError(exec);
...
EncodedJSValue JSC_HOST_CALL jsDataGridColumnListPrototypeFunctionClear(ExecState* exec)
{
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDataGridColumnList::s_info))
        return throwVMTypeError(exec);
