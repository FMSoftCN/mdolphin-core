...
public:
    JSClientRectConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSClientRectConstructor::JSClientRectConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSClientRectConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSClientRect::s_info = { "ClientRect", &DOMObjectWithGlobalPointer::s_info, &JSClientRectTable, 0 };
...
{
    return new (exec) JSClientRectPrototype(globalObject, JSClientRectPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
