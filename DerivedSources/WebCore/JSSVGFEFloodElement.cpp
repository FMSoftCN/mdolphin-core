...
public:
    JSSVGFEFloodElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEFloodElementConstructor::JSSVGFEFloodElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEFloodElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEFloodElementPrototype(globalObject, JSSVGFEFloodElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
