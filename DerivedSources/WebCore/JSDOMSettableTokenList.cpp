...
public:
    JSDOMSettableTokenListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDOMSettableTokenListConstructor::JSDOMSettableTokenListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMSettableTokenListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDOMSettableTokenListConstructor, DOMObject>(exec, &JSDOMSettableTokenListConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDOMSettableTokenListConstructor, DOMObject>(exec, &JSDOMSettableTokenListConstructorTable, this, propertyName, descriptor);
}
...
JSDOMSettableTokenList::JSDOMSettableTokenList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DOMSettableTokenList> impl)
...
{
    return new (exec) JSDOMSettableTokenListPrototype(globalObject, JSDOMSettableTokenListPrototype::createStructure(exec->globalData(), JSDOMTokenListPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DOMSettableTokenList* object)
{
    return getDOMObjectWrapper<JSDOMSettableTokenList>(exec, globalObject, object);
}
