...
const ClassInfo JSDOMApplicationCache::s_info = { "DOMApplicationCache", &DOMObjectWithGlobalPointer::s_info, &JSDOMApplicationCacheTable, 0 };
...
{
    return new (exec) JSDOMApplicationCachePrototype(globalObject, JSDOMApplicationCachePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
