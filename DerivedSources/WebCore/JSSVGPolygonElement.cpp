...
public:
    JSSVGPolygonElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPolygonElementConstructor::JSSVGPolygonElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPolygonElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPolygonElementPrototype(globalObject, JSSVGPolygonElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
