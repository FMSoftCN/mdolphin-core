...
public:
    JSHTMLTextAreaElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLTextAreaElementConstructor::JSHTMLTextAreaElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLTextAreaElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLTextAreaElementPrototype(globalObject, JSHTMLTextAreaElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
