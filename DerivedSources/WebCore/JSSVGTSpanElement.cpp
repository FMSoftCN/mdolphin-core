...
public:
    JSSVGTSpanElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGTSpanElementConstructor::JSSVGTSpanElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTSpanElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGTSpanElementPrototype(globalObject, JSSVGTSpanElementPrototype::createStructure(exec->globalData(), JSSVGTextPositioningElementPrototype::self(exec, globalObject)));
}
