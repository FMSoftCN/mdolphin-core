...
JSHTMLAudioElementConstructor::JSHTMLAudioElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLAudioElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLAudioElementPrototype(globalObject, JSHTMLAudioElementPrototype::createStructure(exec->globalData(), JSHTMLMediaElementPrototype::self(exec, globalObject)));
}
