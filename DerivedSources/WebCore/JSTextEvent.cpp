...
public:
    JSTextEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSTextEventConstructor::JSTextEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTextEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSTextEventPrototype(globalObject, JSTextEventPrototype::createStructure(exec->globalData(), JSUIEventPrototype::self(exec, globalObject)));
}
