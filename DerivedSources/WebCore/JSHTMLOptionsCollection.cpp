...
JSHTMLOptionsCollectionConstructor::JSHTMLOptionsCollectionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLOptionsCollectionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLOptionsCollectionPrototype(globalObject, JSHTMLOptionsCollectionPrototype::createStructure(exec->globalData(), JSHTMLCollectionPrototype::self(exec, globalObject)));
}
