...
JSSVGStringListConstructor::JSSVGStringListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGStringListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGStringList::s_info = { "SVGStringList", &DOMObjectWithGlobalPointer::s_info, &JSSVGStringListTable, 0 };

JSSVGStringList::JSSVGStringList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGStaticListPropertyTearOff<SVGStringList> > impl)
...
{
    return new (exec) JSSVGStringListPrototype(globalObject, JSSVGStringListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGStaticListPropertyTearOff<SVGStringList> * object)
{
    return getDOMObjectWrapper<JSSVGStringList>(exec, globalObject, object);
}
