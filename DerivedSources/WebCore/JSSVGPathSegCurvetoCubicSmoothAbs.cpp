...
public:
    JSSVGPathSegCurvetoCubicSmoothAbsConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegCurvetoCubicSmoothAbsConstructor::JSSVGPathSegCurvetoCubicSmoothAbsConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegCurvetoCubicSmoothAbsConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegCurvetoCubicSmoothAbsPrototype(globalObject, JSSVGPathSegCurvetoCubicSmoothAbsPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
