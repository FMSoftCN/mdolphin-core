...
public:
    JSCSSFontFaceRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSFontFaceRuleConstructor::JSCSSFontFaceRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSFontFaceRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCSSFontFaceRulePrototype(globalObject, JSCSSFontFaceRulePrototype::createStructure(exec->globalData(), JSCSSRulePrototype::self(exec, globalObject)));
}
