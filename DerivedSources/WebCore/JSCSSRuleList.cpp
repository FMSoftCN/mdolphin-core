...
public:
    JSCSSRuleListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSRuleListConstructor::JSCSSRuleListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSRuleListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCSSRuleList::s_info = { "CSSRuleList", &DOMObjectWithGlobalPointer::s_info, &JSCSSRuleListTable, 0 };
...
{
    return new (exec) JSCSSRuleListPrototype(globalObject, JSCSSRuleListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
