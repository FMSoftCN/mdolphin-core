...
JSCSSValueConstructor::JSCSSValueConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSValueConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCSSValue::s_info = { "CSSValue", &DOMObjectWithGlobalPointer::s_info, &JSCSSValueTable, 0 };
...
{
    return new (exec) JSCSSValuePrototype(globalObject, JSCSSValuePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
