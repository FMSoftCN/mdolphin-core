...
public:
    JSDirectoryEntryConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDirectoryEntryConstructor::JSDirectoryEntryConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDirectoryEntryConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDirectoryEntryConstructor, DOMObject>(exec, &JSDirectoryEntryConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDirectoryEntryConstructor, DOMObject>(exec, &JSDirectoryEntryConstructorTable, this, propertyName, descriptor);
}
...
JSDirectoryEntry::JSDirectoryEntry(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DirectoryEntry> impl)
...
{
    return new (exec) JSDirectoryEntryPrototype(globalObject, JSDirectoryEntryPrototype::createStructure(exec->globalData(), JSEntryPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DirectoryEntry* object)
{
    return getDOMObjectWrapper<JSDirectoryEntry>(exec, globalObject, object);
}
