...
public:
    JSHTMLDivElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLDivElementConstructor::JSHTMLDivElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLDivElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLDivElementPrototype(globalObject, JSHTMLDivElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
