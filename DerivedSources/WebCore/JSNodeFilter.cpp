...
public:
    JSNodeFilterConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSNodeFilterConstructor::JSNodeFilterConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSNodeFilterConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSNodeFilter::s_info = { "NodeFilter", &DOMObjectWithGlobalPointer::s_info, &JSNodeFilterTable, 0 };
...
{
    return new (exec) JSNodeFilterPrototype(globalObject, JSNodeFilterPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
