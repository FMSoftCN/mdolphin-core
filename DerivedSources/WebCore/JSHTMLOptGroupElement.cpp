...
public:
    JSHTMLOptGroupElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLOptGroupElementConstructor::JSHTMLOptGroupElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLOptGroupElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLOptGroupElementPrototype(globalObject, JSHTMLOptGroupElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
