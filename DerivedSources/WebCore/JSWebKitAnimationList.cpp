...
public:
    JSWebKitAnimationListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebKitAnimationListConstructor::JSWebKitAnimationListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitAnimationListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebKitAnimationListConstructor, DOMObject>(exec, &JSWebKitAnimationListConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebKitAnimationListConstructor, DOMObject>(exec, &JSWebKitAnimationListConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebKitAnimationList::s_info = { "WebKitAnimationList", &DOMObjectWithGlobalPointer::s_info, &JSWebKitAnimationListTable, 0 };

JSWebKitAnimationList::JSWebKitAnimationList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<WebKitAnimationList> impl)
...
{
    return new (exec) JSWebKitAnimationListPrototype(globalObject, JSWebKitAnimationListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, WebKitAnimationList* object)
{
    return getDOMObjectWrapper<JSWebKitAnimationList>(exec, globalObject, object);
}
