...
JSInjectedScriptHostConstructor::JSInjectedScriptHostConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSInjectedScriptHostConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
static const HashTableValue JSInjectedScriptHostPrototypeTableValues[12] =
{
...
#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSInjectedScriptHostPrototypeTable = { 32, 31, JSInjectedScriptHostPrototypeTableValues, 0 };
...
const ClassInfo JSInjectedScriptHost::s_info = { "InjectedScriptHost", &DOMObjectWithGlobalPointer::s_info, &JSInjectedScriptHostTable, 0 };
...
{
    return new (exec) JSInjectedScriptHostPrototype(globalObject, JSInjectedScriptHostPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
