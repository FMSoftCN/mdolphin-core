...
public:
    JSStyleSheetListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSStyleSheetListConstructor::JSStyleSheetListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSStyleSheetListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSStyleSheetList::s_info = { "StyleSheetList", &DOMObjectWithGlobalPointer::s_info, &JSStyleSheetListTable, 0 };
...
{
    return new (exec) JSStyleSheetListPrototype(globalObject, JSStyleSheetListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
