...
JSFileListConstructor::JSFileListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSFileList::s_info = { "FileList", &DOMObjectWithGlobalPointer::s_info, 0, getJSFileListTable };
...
{
    return new (exec) JSFileListPrototype(globalObject, JSFileListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
