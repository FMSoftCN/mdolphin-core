...
public:
    JSSVGFontFaceFormatElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFontFaceFormatElementConstructor::JSSVGFontFaceFormatElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFontFaceFormatElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFontFaceFormatElementPrototype(globalObject, JSSVGFontFaceFormatElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
