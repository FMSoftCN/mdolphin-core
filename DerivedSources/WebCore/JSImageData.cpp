...
public:
    JSImageDataConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSImageDataConstructor::JSImageDataConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSImageDataConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSImageData::s_info = { "ImageData", &DOMObjectWithGlobalPointer::s_info, &JSImageDataTable, 0 };
...
{
    return new (exec) JSImageDataPrototype(globalObject, JSImageDataPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
