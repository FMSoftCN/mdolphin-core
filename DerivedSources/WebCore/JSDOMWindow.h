...
public:
    ...
    JSDOMWindowPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
...
JSC::EncodedJSValue JSC_HOST_CALL jsDOMWindowPrototypeFunctionMdprint(JSC::ExecState*);
...
JSC::EncodedJSValue JSC_HOST_CALL jsDOMWindowPrototypeFunctionRequestFileSystem(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsDOMWindowPrototypeFunctionResolveLocalFileSystemURL(JSC::ExecState*);
...
JSC::JSValue jsDOMWindowFlagsConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowFlagsConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
...
JSC::JSValue jsDOMWindowWebKitAnimationConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowWebKitAnimationConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDOMWindowWebKitAnimationListConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowWebKitAnimationListConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
...
JSC::JSValue jsDOMWindowBlobBuilderConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowBlobBuilderConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
...
JSC::JSValue jsDOMWindowTEMPORARY(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsDOMWindowPERSISTENT(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
