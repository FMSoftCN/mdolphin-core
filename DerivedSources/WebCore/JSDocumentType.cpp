...
public:
    JSDocumentTypeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDocumentTypeConstructor::JSDocumentTypeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDocumentTypeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSDocumentTypePrototype(globalObject, JSDocumentTypePrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
