...
const ClassInfo JSSQLResultSetRowList::s_info = { "SQLResultSetRowList", &DOMObjectWithGlobalPointer::s_info, 0, getJSSQLResultSetRowListTable };
...
{
    return new (exec) JSSQLResultSetRowListPrototype(globalObject, JSSQLResultSetRowListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
