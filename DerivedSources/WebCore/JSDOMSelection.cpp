...
const ClassInfo JSDOMSelection::s_info = { "DOMSelection", &DOMObjectWithGlobalPointer::s_info, &JSDOMSelectionTable, 0 };
...
{
    return new (exec) JSDOMSelectionPrototype(globalObject, JSDOMSelectionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
