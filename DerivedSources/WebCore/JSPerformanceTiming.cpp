...
const ClassInfo JSPerformanceTiming::s_info = { "PerformanceTiming", &DOMObjectWithGlobalPointer::s_info, &JSPerformanceTimingTable, 0 };

JSPerformanceTiming::JSPerformanceTiming(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<PerformanceTiming> impl)
...
{
    return new (exec) JSPerformanceTimingPrototype(globalObject, JSPerformanceTimingPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, PerformanceTiming* object)
{
    return getDOMObjectWrapper<JSPerformanceTiming>(exec, globalObject, object);
}
