...
public:
    JSSVGPathSegLinetoVerticalRelConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegLinetoVerticalRelConstructor::JSSVGPathSegLinetoVerticalRelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegLinetoVerticalRelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegLinetoVerticalRelPrototype(globalObject, JSSVGPathSegLinetoVerticalRelPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
