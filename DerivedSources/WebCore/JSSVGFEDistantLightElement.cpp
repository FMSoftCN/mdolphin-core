...
public:
    JSSVGFEDistantLightElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEDistantLightElementConstructor::JSSVGFEDistantLightElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEDistantLightElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEDistantLightElementPrototype(globalObject, JSSVGFEDistantLightElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
