...
public:
    JSSVGAnimatedNumberConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedNumberConstructor::JSSVGAnimatedNumberConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedNumberConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedNumber::s_info = { "SVGAnimatedNumber", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedNumberTable, 0 };
...
{
    return new (exec) JSSVGAnimatedNumberPrototype(globalObject, JSSVGAnimatedNumberPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedNumber* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedNumber>(exec, globalObject, object);
}
