...
public:
    JSSpeechInputEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSpeechInputEventConstructor::JSSpeechInputEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSpeechInputEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSSpeechInputEventConstructor, DOMObject>(exec, &JSSpeechInputEventConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSSpeechInputEventConstructor, DOMObject>(exec, &JSSpeechInputEventConstructorTable, this, propertyName, descriptor);
}
...
JSSpeechInputEvent::JSSpeechInputEvent(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SpeechInputEvent> impl)
...
{
    return new (exec) JSSpeechInputEventPrototype(globalObject, JSSpeechInputEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
