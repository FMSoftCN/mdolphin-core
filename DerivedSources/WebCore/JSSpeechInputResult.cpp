...
public:
    JSSpeechInputResultConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSpeechInputResultConstructor::JSSpeechInputResultConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSpeechInputResultConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSSpeechInputResultConstructor, DOMObject>(exec, &JSSpeechInputResultConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSSpeechInputResultConstructor, DOMObject>(exec, &JSSpeechInputResultConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSSpeechInputResult::s_info = { "SpeechInputResult", &DOMObjectWithGlobalPointer::s_info, &JSSpeechInputResultTable, 0 };

JSSpeechInputResult::JSSpeechInputResult(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SpeechInputResult> impl)
...
{
    return new (exec) JSSpeechInputResultPrototype(globalObject, JSSpeechInputResultPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SpeechInputResult* object)
{
    return getDOMObjectWrapper<JSSpeechInputResult>(exec, globalObject, object);
}
