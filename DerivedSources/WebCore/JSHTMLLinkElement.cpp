...
public:
    JSHTMLLinkElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLLinkElementConstructor::JSHTMLLinkElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLLinkElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLLinkElementPrototype(globalObject, JSHTMLLinkElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
