...
public:
    JSTimeRangesConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSTimeRangesConstructor::JSTimeRangesConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTimeRangesConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSTimeRangesConstructor, DOMObject>(exec, &JSTimeRangesConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSTimeRangesConstructor, DOMObject>(exec, &JSTimeRangesConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSTimeRanges::s_info = { "TimeRanges", &DOMObjectWithGlobalPointer::s_info, &JSTimeRangesTable, 0 };
...
{
    return new (exec) JSTimeRangesPrototype(globalObject, JSTimeRangesPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
