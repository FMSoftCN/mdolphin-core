...
public:
    JSTextConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSTextConstructor::JSTextConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTextConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSTextPrototype(globalObject, JSTextPrototype::createStructure(exec->globalData(), JSCharacterDataPrototype::self(exec, globalObject)));
}
