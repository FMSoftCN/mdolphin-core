...
public:
    JSCSSStyleSheetConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSStyleSheetConstructor::JSCSSStyleSheetConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSStyleSheetConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCSSStyleSheetPrototype(globalObject, JSCSSStyleSheetPrototype::createStructure(exec->globalData(), JSStyleSheetPrototype::self(exec, globalObject)));
}
