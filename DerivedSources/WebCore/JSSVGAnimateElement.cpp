...
public:
    JSSVGAnimateElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimateElementConstructor::JSSVGAnimateElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimateElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGAnimateElementPrototype(globalObject, JSSVGAnimateElementPrototype::createStructure(exec->globalData(), JSSVGAnimationElementPrototype::self(exec, globalObject)));
}
