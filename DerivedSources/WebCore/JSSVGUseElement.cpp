...
public:
    JSSVGUseElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGUseElementConstructor::JSSVGUseElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGUseElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGUseElementPrototype(globalObject, JSSVGUseElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
