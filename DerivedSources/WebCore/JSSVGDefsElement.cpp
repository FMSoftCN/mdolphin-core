...
public:
    JSSVGDefsElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGDefsElementConstructor::JSSVGDefsElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGDefsElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGDefsElementPrototype(globalObject, JSSVGDefsElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
