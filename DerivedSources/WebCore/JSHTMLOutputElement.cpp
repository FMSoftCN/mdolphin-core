...
public:
    JSHTMLOutputElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLOutputElementConstructor::JSHTMLOutputElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLOutputElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSHTMLOutputElementConstructor, DOMObject>(exec, &JSHTMLOutputElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHTMLOutputElementConstructor, DOMObject>(exec, &JSHTMLOutputElementConstructorTable, this, propertyName, descriptor);
}
...
JSHTMLOutputElement::JSHTMLOutputElement(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<HTMLOutputElement> impl)
...
{
    return new (exec) JSHTMLOutputElementPrototype(globalObject, JSHTMLOutputElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
