...
public:
    JSWebGLTextureConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLTextureConstructor::JSWebGLTextureConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLTextureConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLTextureConstructor, DOMObject>(exec, &JSWebGLTextureConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLTextureConstructor, DOMObject>(exec, &JSWebGLTextureConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLTexture::s_info = { "WebGLTexture", &DOMObjectWithGlobalPointer::s_info, &JSWebGLTextureTable, 0 };
...
{
    return new (exec) JSWebGLTexturePrototype(globalObject, JSWebGLTexturePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
