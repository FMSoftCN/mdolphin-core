...
JSXPathExceptionConstructor::JSXPathExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXPathExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXPathException::s_info = { "XPathException", &DOMObjectWithGlobalPointer::s_info, &JSXPathExceptionTable, 0 };
...
{
    return new (exec) JSXPathExceptionPrototype(globalObject, JSXPathExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
