...
JSSVGPointConstructor::JSSVGPointConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPointConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGPoint::s_info = { "SVGPoint", &DOMObjectWithGlobalPointer::s_info, &JSSVGPointTable, 0 };

JSSVGPoint::JSSVGPoint(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPropertyTearOff<FloatPoint> > impl)
...
{
    return new (exec) JSSVGPointPrototype(globalObject, JSSVGPointPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPropertyTearOff<FloatPoint> * object)
{
    return getDOMObjectWrapper<JSSVGPoint, SVGPropertyTearOff<FloatPoint> >(exec, globalObject, object);
}
