...
public:
    JSWebKitAnimationConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebKitAnimationConstructor::JSWebKitAnimationConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitAnimationConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebKitAnimationConstructor, DOMObject>(exec, &JSWebKitAnimationConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebKitAnimationConstructor, DOMObject>(exec, &JSWebKitAnimationConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebKitAnimation::s_info = { "WebKitAnimation", &DOMObjectWithGlobalPointer::s_info, &JSWebKitAnimationTable, 0 };

JSWebKitAnimation::JSWebKitAnimation(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<WebKitAnimation> impl)
...
{
    return new (exec) JSWebKitAnimationPrototype(globalObject, JSWebKitAnimationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, WebKitAnimation* object)
{
    return getDOMObjectWrapper<JSWebKitAnimation>(exec, globalObject, object);
}
