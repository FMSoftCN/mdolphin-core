...
JSCanvasPatternConstructor::JSCanvasPatternConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCanvasPatternConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCanvasPattern::s_info = { "CanvasPattern", &DOMObjectWithGlobalPointer::s_info, &JSCanvasPatternTable, 0 };
...
{
    return new (exec) JSCanvasPatternPrototype(globalObject, JSCanvasPatternPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
