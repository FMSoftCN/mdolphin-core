...
JSEventExceptionConstructor::JSEventExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEventExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSEventException::s_info = { "EventException", &DOMObjectWithGlobalPointer::s_info, 0, getJSEventExceptionTable };
...
{
    return new (exec) JSEventExceptionPrototype(globalObject, JSEventExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
