...
JSNodeIteratorConstructor::JSNodeIteratorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSNodeIteratorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSNodeIterator::s_info = { "NodeIterator", &DOMObjectWithGlobalPointer::s_info, &JSNodeIteratorTable, 0 };
...
{
    return new (exec) JSNodeIteratorPrototype(globalObject, JSNodeIteratorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
