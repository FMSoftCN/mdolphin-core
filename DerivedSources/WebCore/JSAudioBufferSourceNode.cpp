...
public:
    JSAudioBufferSourceNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioBufferSourceNodeConstructor::JSAudioBufferSourceNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioBufferSourceNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioBufferSourceNodeConstructor, DOMObject>(exec, &JSAudioBufferSourceNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioBufferSourceNodeConstructor, DOMObject>(exec, &JSAudioBufferSourceNodeConstructorTable, this, propertyName, descriptor);
}
...
JSAudioBufferSourceNode::JSAudioBufferSourceNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioBufferSourceNode> impl)
...
{
    return new (exec) JSAudioBufferSourceNodePrototype(globalObject, JSAudioBufferSourceNodePrototype::createStructure(exec->globalData(), JSAudioSourceNodePrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioBufferSourceNode* object)
{
    return getDOMObjectWrapper<JSAudioBufferSourceNode>(exec, globalObject, object);
}
