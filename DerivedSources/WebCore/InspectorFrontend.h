...
public:
    ...
    public:
        ...
        void domContentEventFired(double time);
        void loadEventFired(double time);
        void setInspectorFrontendChannel(InspectorFrontendChannel* inspectorFrontendChannel) { m_inspectorFrontendChannel = inspectorFrontendChannel; }
        InspectorFrontendChannel* getInspectorFrontendChannel() { return m_inspectorFrontendChannel; }
    private:
        InspectorFrontendChannel* m_inspectorFrontendChannel;
    ...
    public:
        ...
        void requestWillBeSent(int identifier, const String& frameId, const String& loaderId, const String& documentURL, PassRefPtr<InspectorObject> request, PassRefPtr<InspectorObject> redirectResponse, double time, PassRefPtr<InspectorArray> callStack);
        void resourceMarkedAsCached(int identifier);
        void responseReceived(int identifier, double time, const String& type, PassRefPtr<InspectorObject> response);
        void dataReceived(int identifier, double time, int dataLength, int lengthReceived);
        void loadingFinished(int identifier, double finishTime);
        void loadingFailed(int identifier, double time, const String& errorText);
        void resourceLoadedFromMemoryCache(const String& frameId, const String& loaderId, const String& documentURL, double time, PassRefPtr<InspectorObject> resource);
        ...
        void webSocketWillSendHandshakeRequest(int identifier, double time, PassRefPtr<InspectorObject> request);
        void webSocketHandshakeResponseReceived(int identifier, double time, PassRefPtr<InspectorObject> response);
        void webSocketCreated(int identifier, const String& url);
        void webSocketClosed(int identifier, double time);
        void setInspectorFrontendChannel(InspectorFrontendChannel* inspectorFrontendChannel) { m_inspectorFrontendChannel = inspectorFrontendChannel; }
        InspectorFrontendChannel* getInspectorFrontendChannel() { return m_inspectorFrontendChannel; }
    private:
        InspectorFrontendChannel* m_inspectorFrontendChannel;
    ...
    public:
        ...
        void scriptParsed(const String& sourceID, const String& url, int lineOffset, int columnOffset, int length, int scriptWorldType);
