...
public:
    JSKeyboardEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSKeyboardEventConstructor::JSKeyboardEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSKeyboardEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSKeyboardEventPrototype(globalObject, JSKeyboardEventPrototype::createStructure(exec->globalData(), JSUIEventPrototype::self(exec, globalObject)));
}
