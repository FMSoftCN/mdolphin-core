...
public:
    JSSVGLineElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGLineElementConstructor::JSSVGLineElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGLineElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGLineElementPrototype(globalObject, JSSVGLineElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
