...
void InspectorFrontend::Page::inspectedURLChanged(const String& url)
{
    RefPtr<InspectorObject> inspectedURLChangedMessage = InspectorObject::create();
    inspectedURLChangedMessage->setString("method", "Page.inspectedURLChanged");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setString("url", url);
    inspectedURLChangedMessage->setObject("params", paramsObject);
    m_inspectorFrontendChannel->sendMessageToFrontend(inspectedURLChangedMessage->toJSONString());
}

void InspectorFrontend::Page::domContentEventFired(double time)
{
    ...
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("time", time);
...
void InspectorFrontend::Page::loadEventFired(double time)
{
...
void InspectorFrontend::Network::frameDetached(const String& frameId)
{
    RefPtr<InspectorObject> frameDetachedMessage = InspectorObject::create();
    frameDetachedMessage->setString("method", "Network.frameDetached");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
...
void InspectorFrontend::Network::requestWillBeSent(int identifier, const String& frameId, const String& loaderId, const String& documentURL, PassRefPtr<InspectorObject> request, PassRefPtr<InspectorObject> redirectResponse, double time, PassRefPtr<InspectorArray> callStack)
{
    ...
    paramsObject->setNumber("time", time);
    paramsObject->setArray("callStack", callStack);
...
void InspectorFrontend::Network::responseReceived(int identifier, double time, const String& type, PassRefPtr<InspectorObject> response)
{
...
void InspectorFrontend::Network::dataReceived(int identifier, double time, int dataLength, int lengthReceived)
{
    ...
    paramsObject->setNumber("lengthReceived", lengthReceived);
...
void InspectorFrontend::Network::loadingFinished(int identifier, double finishTime)
{
    ...
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
    paramsObject->setNumber("identifier", identifier);
    paramsObject->setNumber("finishTime", finishTime);
...
void InspectorFrontend::Network::loadingFailed(int identifier, double time, const String& errorText)
{
...
void InspectorFrontend::Network::resourceLoadedFromMemoryCache(const String& frameId, const String& loaderId, const String& documentURL, double time, PassRefPtr<InspectorObject> resource)
{
...
void InspectorFrontend::Network::frameNavigated(PassRefPtr<InspectorObject> frame, const String& loaderId)
{
    RefPtr<InspectorObject> frameNavigatedMessage = InspectorObject::create();
    frameNavigatedMessage->setString("method", "Network.frameNavigated");
    RefPtr<InspectorObject> paramsObject = InspectorObject::create();
...
void InspectorFrontend::Network::webSocketWillSendHandshakeRequest(int identifier, double time, PassRefPtr<InspectorObject> request)
{
...
void InspectorFrontend::Network::webSocketHandshakeResponseReceived(int identifier, double time, PassRefPtr<InspectorObject> response)
{
...
void InspectorFrontend::Network::webSocketClosed(int identifier, double time)
{
...
void InspectorFrontend::Debugger::scriptParsed(const String& sourceID, const String& url, int lineOffset, int columnOffset, int length, int scriptWorldType)
{
    ...
    paramsObject->setString("url", url);
    paramsObject->setNumber("lineOffset", lineOffset);
    paramsObject->setNumber("columnOffset", columnOffset);
    paramsObject->setNumber("length", length);
    paramsObject->setNumber("scriptWorldType", scriptWorldType);
