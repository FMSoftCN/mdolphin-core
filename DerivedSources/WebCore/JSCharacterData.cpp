...
public:
    JSCharacterDataConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCharacterDataConstructor::JSCharacterDataConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCharacterDataConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCharacterDataPrototype(globalObject, JSCharacterDataPrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
