...
public:
    JSSVGSetElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGSetElementConstructor::JSSVGSetElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGSetElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGSetElementPrototype(globalObject, JSSVGSetElementPrototype::createStructure(exec->globalData(), JSSVGAnimationElementPrototype::self(exec, globalObject)));
}
