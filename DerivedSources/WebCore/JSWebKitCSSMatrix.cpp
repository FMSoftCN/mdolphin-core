...
JSWebKitCSSMatrixConstructor::JSWebKitCSSMatrixConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitCSSMatrixConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebKitCSSMatrixConstructor, DOMObject>(exec, &JSWebKitCSSMatrixConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebKitCSSMatrixConstructor, DOMObject>(exec, &JSWebKitCSSMatrixConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebKitCSSMatrix::s_info = { "WebKitCSSMatrix", &DOMObjectWithGlobalPointer::s_info, &JSWebKitCSSMatrixTable, 0 };
...
{
    return new (exec) JSWebKitCSSMatrixPrototype(globalObject, JSWebKitCSSMatrixPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
