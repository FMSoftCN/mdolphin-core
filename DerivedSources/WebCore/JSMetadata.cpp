...
public:
    JSMetadataConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSMetadataConstructor::JSMetadataConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSMetadataConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSMetadataConstructor, DOMObject>(exec, &JSMetadataConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSMetadataConstructor, DOMObject>(exec, &JSMetadataConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSMetadata::s_info = { "Metadata", &DOMObjectWithGlobalPointer::s_info, 0, getJSMetadataTable };

JSMetadata::JSMetadata(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<Metadata> impl)
...
{
    return new (exec) JSMetadataPrototype(globalObject, JSMetadataPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, Metadata* object)
{
    return getDOMObjectWrapper<JSMetadata>(exec, globalObject, object);
}
