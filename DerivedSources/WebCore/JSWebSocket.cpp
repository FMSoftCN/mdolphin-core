...
JSWebSocketConstructor::JSWebSocketConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebSocketConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSWebSocket::s_info = { "WebSocket", &DOMObjectWithGlobalPointer::s_info, 0, getJSWebSocketTable };
...
{
    return new (exec) JSWebSocketPrototype(globalObject, JSWebSocketPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
