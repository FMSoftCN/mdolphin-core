...
public:
    JSSVGTextElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGTextElementConstructor::JSSVGTextElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTextElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGTextElementPrototype(globalObject, JSSVGTextElementPrototype::createStructure(exec->globalData(), JSSVGTextPositioningElementPrototype::self(exec, globalObject)));
}
