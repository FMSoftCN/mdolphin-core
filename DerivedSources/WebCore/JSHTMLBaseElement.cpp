...
public:
    JSHTMLBaseElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLBaseElementConstructor::JSHTMLBaseElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLBaseElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLBaseElementPrototype(globalObject, JSHTMLBaseElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
