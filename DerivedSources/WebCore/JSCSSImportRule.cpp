...
public:
    JSCSSImportRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSImportRuleConstructor::JSCSSImportRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSImportRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCSSImportRulePrototype(globalObject, JSCSSImportRulePrototype::createStructure(exec->globalData(), JSCSSRulePrototype::self(exec, globalObject)));
}
