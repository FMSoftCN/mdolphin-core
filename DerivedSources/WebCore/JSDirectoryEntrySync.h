...
public:
    JSDirectoryEntrySync(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<DirectoryEntrySync>);
...
public:
    ...
    JSDirectoryEntrySyncPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
