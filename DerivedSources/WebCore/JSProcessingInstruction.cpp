...
public:
    JSProcessingInstructionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSProcessingInstructionConstructor::JSProcessingInstructionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSProcessingInstructionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSProcessingInstructionPrototype(globalObject, JSProcessingInstructionPrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
