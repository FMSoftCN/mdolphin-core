...
public:
    JSDOMFileSystemSyncConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDOMFileSystemSyncConstructor::JSDOMFileSystemSyncConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMFileSystemSyncConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDOMFileSystemSyncConstructor, DOMObject>(exec, &JSDOMFileSystemSyncConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDOMFileSystemSyncConstructor, DOMObject>(exec, &JSDOMFileSystemSyncConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDOMFileSystemSync::s_info = { "DOMFileSystemSync", &DOMObjectWithGlobalPointer::s_info, 0, getJSDOMFileSystemSyncTable };

JSDOMFileSystemSync::JSDOMFileSystemSync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DOMFileSystemSync> impl)
...
{
    return new (exec) JSDOMFileSystemSyncPrototype(globalObject, JSDOMFileSystemSyncPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DOMFileSystemSync* object)
{
    return getDOMObjectWrapper<JSDOMFileSystemSync>(exec, globalObject, object);
}
