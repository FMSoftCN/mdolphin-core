...
const ClassInfo JSXPathNSResolver::s_info = { "XPathNSResolver", &DOMObjectWithGlobalPointer::s_info, 0, 0 };
...
{
    return new (exec) JSXPathNSResolverPrototype(globalObject, JSXPathNSResolverPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
