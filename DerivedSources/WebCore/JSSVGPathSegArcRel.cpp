...
public:
    JSSVGPathSegArcRelConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegArcRelConstructor::JSSVGPathSegArcRelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegArcRelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegArcRelPrototype(globalObject, JSSVGPathSegArcRelPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
