...
public:
    JSSVGUnitTypesConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGUnitTypesConstructor::JSSVGUnitTypesConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGUnitTypesConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGUnitTypes::s_info = { "SVGUnitTypes", &DOMObjectWithGlobalPointer::s_info, &JSSVGUnitTypesTable, 0 };
...
{
    return new (exec) JSSVGUnitTypesPrototype(globalObject, JSSVGUnitTypesPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGUnitTypes* object)
{
    return getDOMObjectWrapper<JSSVGUnitTypes>(exec, globalObject, object);
}
