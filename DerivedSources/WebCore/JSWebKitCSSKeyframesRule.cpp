...
public:
    JSWebKitCSSKeyframesRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebKitCSSKeyframesRuleConstructor::JSWebKitCSSKeyframesRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitCSSKeyframesRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSWebKitCSSKeyframesRulePrototype(globalObject, JSWebKitCSSKeyframesRulePrototype::createStructure(exec->globalData(), JSCSSRulePrototype::self(exec, globalObject)));
}
