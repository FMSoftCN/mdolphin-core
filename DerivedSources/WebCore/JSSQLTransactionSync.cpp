...
const ClassInfo JSSQLTransactionSync::s_info = { "SQLTransactionSync", &DOMObjectWithGlobalPointer::s_info, 0, 0 };

JSSQLTransactionSync::JSSQLTransactionSync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SQLTransactionSync> impl)
...
{
    return new (exec) JSSQLTransactionSyncPrototype(globalObject, JSSQLTransactionSyncPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SQLTransactionSync* object)
{
    return getDOMObjectWrapper<JSSQLTransactionSync>(exec, globalObject, object);
}
