...
public:
    JSSVGScriptElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGScriptElementConstructor::JSSVGScriptElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGScriptElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGScriptElementPrototype(globalObject, JSSVGScriptElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
