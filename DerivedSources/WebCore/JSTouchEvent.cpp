...
public:
    JSTouchEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSTouchEventConstructor::JSTouchEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTouchEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSTouchEventPrototype(globalObject, JSTouchEventPrototype::createStructure(exec->globalData(), JSUIEventPrototype::self(exec, globalObject)));
}
