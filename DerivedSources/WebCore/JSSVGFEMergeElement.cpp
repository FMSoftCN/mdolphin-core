...
public:
    JSSVGFEMergeElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEMergeElementConstructor::JSSVGFEMergeElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEMergeElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEMergeElementPrototype(globalObject, JSSVGFEMergeElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
