...
public:
    JSHTMLProgressElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLProgressElementConstructor::JSHTMLProgressElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLProgressElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLProgressElementPrototype(globalObject, JSHTMLProgressElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
