...
public:
    JSSVGFETileElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFETileElementConstructor::JSSVGFETileElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFETileElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFETileElementPrototype(globalObject, JSSVGFETileElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
