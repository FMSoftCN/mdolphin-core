...
public:
    JSHTMLFontElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLFontElementConstructor::JSHTMLFontElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLFontElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLFontElementPrototype(globalObject, JSHTMLFontElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
