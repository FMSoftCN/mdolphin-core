...
public:
    JSSVGDocumentConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGDocumentConstructor::JSSVGDocumentConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGDocumentConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGDocumentPrototype(globalObject, JSSVGDocumentPrototype::createStructure(exec->globalData(), JSDocumentPrototype::self(exec, globalObject)));
}
