...
public:
    JSHTMLTableSectionElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLTableSectionElementConstructor::JSHTMLTableSectionElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLTableSectionElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLTableSectionElementPrototype(globalObject, JSHTMLTableSectionElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
