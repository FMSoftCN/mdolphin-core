...
public:
    JSHTMLIsIndexElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLIsIndexElementConstructor::JSHTMLIsIndexElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLIsIndexElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLIsIndexElementPrototype(globalObject, JSHTMLIsIndexElementPrototype::createStructure(exec->globalData(), JSHTMLInputElementPrototype::self(exec, globalObject)));
}
