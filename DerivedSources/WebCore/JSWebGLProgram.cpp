...
public:
    JSWebGLProgramConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLProgramConstructor::JSWebGLProgramConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLProgramConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLProgramConstructor, DOMObject>(exec, &JSWebGLProgramConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLProgramConstructor, DOMObject>(exec, &JSWebGLProgramConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLProgram::s_info = { "WebGLProgram", &DOMObjectWithGlobalPointer::s_info, &JSWebGLProgramTable, 0 };
...
{
    return new (exec) JSWebGLProgramPrototype(globalObject, JSWebGLProgramPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
