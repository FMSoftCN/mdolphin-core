...
public:
    JSInt16Array(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<Int16Array>);
...
public:
    ...
    JSInt16ArrayPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
