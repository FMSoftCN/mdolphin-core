...
public:
    JSSVGPathSegMovetoRelConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegMovetoRelConstructor::JSSVGPathSegMovetoRelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegMovetoRelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegMovetoRelPrototype(globalObject, JSSVGPathSegMovetoRelPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
