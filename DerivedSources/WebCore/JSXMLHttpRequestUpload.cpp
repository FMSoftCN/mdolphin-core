...
public:
    JSXMLHttpRequestUploadConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSXMLHttpRequestUploadConstructor::JSXMLHttpRequestUploadConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXMLHttpRequestUploadConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXMLHttpRequestUpload::s_info = { "XMLHttpRequestUpload", &DOMObjectWithGlobalPointer::s_info, 0, getJSXMLHttpRequestUploadTable };
...
{
    return new (exec) JSXMLHttpRequestUploadPrototype(globalObject, JSXMLHttpRequestUploadPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
