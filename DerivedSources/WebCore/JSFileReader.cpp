...
JSFileReaderConstructor::JSFileReaderConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileReaderConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSFileReader::s_info = { "FileReader", &DOMObjectWithGlobalPointer::s_info, 0, getJSFileReaderTable };
...
{
    return new (exec) JSFileReaderPrototype(globalObject, JSFileReaderPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
