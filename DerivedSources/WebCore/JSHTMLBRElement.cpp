...
public:
    JSHTMLBRElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLBRElementConstructor::JSHTMLBRElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLBRElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLBRElementPrototype(globalObject, JSHTMLBRElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
