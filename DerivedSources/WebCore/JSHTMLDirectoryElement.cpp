...
public:
    JSHTMLDirectoryElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLDirectoryElementConstructor::JSHTMLDirectoryElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLDirectoryElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLDirectoryElementPrototype(globalObject, JSHTMLDirectoryElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
