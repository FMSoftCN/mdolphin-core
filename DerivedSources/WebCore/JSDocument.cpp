...
JSDocumentConstructor::JSDocumentConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDocumentConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
static const HashTableValue JSDocumentPrototypeTableValues[42] =
{
    ...
    { "resetWMLPageState", DontDelete | DontEnum | Function, (intptr_t)static_cast<NativeFunction>(jsDocumentPrototypeFunctionResetWMLPageState), (intptr_t)0 THUNK_GENERATOR(0) },
    { "initializeWMLPageState", DontDelete | DontEnum | Function, (intptr_t)static_cast<NativeFunction>(jsDocumentPrototypeFunctionInitializeWMLPageState), (intptr_t)0 THUNK_GENERATOR(0) },
...
{
    return new (exec) JSDocumentPrototype(globalObject, JSDocumentPrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionResetWMLPageState(ExecState* exec)
{
#if ENABLE(WML)
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDocument::s_info))
    ...
    imp->resetWMLPageState();
#endif
    return JSValue::encode(jsUndefined());
}

EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionInitializeWMLPageState(ExecState* exec)
{
#if ENABLE(WML)
    JSValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(&JSDocument::s_info))
