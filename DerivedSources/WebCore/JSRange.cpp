...
JSRangeConstructor::JSRangeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSRangeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSRange::s_info = { "Range", &DOMObjectWithGlobalPointer::s_info, &JSRangeTable, 0 };
...
{
    return new (exec) JSRangePrototype(globalObject, JSRangePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
