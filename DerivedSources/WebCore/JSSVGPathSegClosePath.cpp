...
public:
    JSSVGPathSegClosePathConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegClosePathConstructor::JSSVGPathSegClosePathConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegClosePathConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegClosePathPrototype(globalObject, JSSVGPathSegClosePathPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
