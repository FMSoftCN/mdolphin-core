...
public:
    JSSVGFEImageElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEImageElementConstructor::JSSVGFEImageElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEImageElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEImageElementPrototype(globalObject, JSSVGFEImageElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
