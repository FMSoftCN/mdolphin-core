...
public:
    JSHTMLBlockquoteElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLBlockquoteElementConstructor::JSHTMLBlockquoteElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLBlockquoteElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLBlockquoteElementPrototype(globalObject, JSHTMLBlockquoteElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
