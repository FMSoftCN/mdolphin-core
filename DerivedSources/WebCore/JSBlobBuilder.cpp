...
const ClassInfo JSBlobBuilderConstructor::s_info = { "BlobBuilderConstructor", &DOMConstructorObject::s_info, &JSBlobBuilderConstructorTable, 0 };

JSBlobBuilderConstructor::JSBlobBuilderConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSBlobBuilderConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
    ASSERT(inherits(&s_info));
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSBlobBuilderPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
const ClassInfo JSBlobBuilderPrototype::s_info = { "BlobBuilderPrototype", &JSC::JSObjectWithGlobalObject::s_info, 0, getJSBlobBuilderPrototypeTable };
...
const ClassInfo JSBlobBuilder::s_info = { "BlobBuilder", &DOMObjectWithGlobalPointer::s_info, 0, getJSBlobBuilderTable };
...
{
    return new (exec) JSBlobBuilderPrototype(globalObject, JSBlobBuilderPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
