...
JSSVGTransformConstructor::JSSVGTransformConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTransformConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGTransform::s_info = { "SVGTransform", &DOMObjectWithGlobalPointer::s_info, &JSSVGTransformTable, 0 };

JSSVGTransform::JSSVGTransform(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPropertyTearOff<SVGTransform> > impl)
...
{
    return new (exec) JSSVGTransformPrototype(globalObject, JSSVGTransformPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPropertyTearOff<SVGTransform> * object)
{
    return getDOMObjectWrapper<JSSVGTransform, SVGPropertyTearOff<SVGTransform> >(exec, globalObject, object);
}
