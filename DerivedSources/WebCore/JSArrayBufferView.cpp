...
const ClassInfo JSArrayBufferView::s_info = { "ArrayBufferView", &DOMObjectWithGlobalPointer::s_info, 0, getJSArrayBufferViewTable };
...
{
    return new (exec) JSArrayBufferViewPrototype(globalObject, JSArrayBufferViewPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
