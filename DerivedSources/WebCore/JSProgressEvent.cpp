...
public:
    JSProgressEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSProgressEventConstructor::JSProgressEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSProgressEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSProgressEventPrototype(globalObject, JSProgressEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
