...
public:
    JSSVGTextPositioningElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGTextPositioningElementConstructor::JSSVGTextPositioningElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTextPositioningElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGTextPositioningElementPrototype(globalObject, JSSVGTextPositioningElementPrototype::createStructure(exec->globalData(), JSSVGTextContentElementPrototype::self(exec, globalObject)));
}
