...
JSDOMImplementationConstructor::JSDOMImplementationConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMImplementationConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSDOMImplementation::s_info = { "DOMImplementation", &DOMObjectWithGlobalPointer::s_info, &JSDOMImplementationTable, 0 };
...
{
    return new (exec) JSDOMImplementationPrototype(globalObject, JSDOMImplementationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
