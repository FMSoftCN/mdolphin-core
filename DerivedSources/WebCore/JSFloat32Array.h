...
public:
    JSFloat32Array(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<Float32Array>);
...
public:
    ...
    JSFloat32ArrayPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
