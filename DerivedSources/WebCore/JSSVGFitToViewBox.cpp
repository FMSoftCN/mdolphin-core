...
const ClassInfo JSSVGFitToViewBox::s_info = { "SVGFitToViewBox", &DOMObjectWithGlobalPointer::s_info, &JSSVGFitToViewBoxTable, 0 };

JSSVGFitToViewBox::JSSVGFitToViewBox(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGFitToViewBox> impl)
...
{
    return new (exec) JSSVGFitToViewBoxPrototype(globalObject, JSSVGFitToViewBoxPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGFitToViewBox* object)
{
    return getDOMObjectWrapper<JSSVGFitToViewBox>(exec, globalObject, object);
}
