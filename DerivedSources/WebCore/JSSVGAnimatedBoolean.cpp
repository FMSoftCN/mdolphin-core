...
public:
    JSSVGAnimatedBooleanConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedBooleanConstructor::JSSVGAnimatedBooleanConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedBooleanConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedBoolean::s_info = { "SVGAnimatedBoolean", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedBooleanTable, 0 };
...
{
    return new (exec) JSSVGAnimatedBooleanPrototype(globalObject, JSSVGAnimatedBooleanPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedBoolean* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedBoolean>(exec, globalObject, object);
}
