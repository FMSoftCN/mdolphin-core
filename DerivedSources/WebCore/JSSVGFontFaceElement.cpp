...
public:
    JSSVGFontFaceElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFontFaceElementConstructor::JSSVGFontFaceElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFontFaceElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFontFaceElementPrototype(globalObject, JSSVGFontFaceElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
