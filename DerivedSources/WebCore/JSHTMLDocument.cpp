...
public:
    JSHTMLDocumentConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLDocumentConstructor::JSHTMLDocumentConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLDocumentConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLDocumentPrototype(globalObject, JSHTMLDocumentPrototype::createStructure(exec->globalData(), JSDocumentPrototype::self(exec, globalObject)));
}
