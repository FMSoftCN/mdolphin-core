...
public:
    JSSVGLinearGradientElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGLinearGradientElementConstructor::JSSVGLinearGradientElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGLinearGradientElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGLinearGradientElementPrototype(globalObject, JSSVGLinearGradientElementPrototype::createStructure(exec->globalData(), JSSVGGradientElementPrototype::self(exec, globalObject)));
}
