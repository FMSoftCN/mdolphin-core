...
public:
    JSSVGPathSegLinetoRelConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegLinetoRelConstructor::JSSVGPathSegLinetoRelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegLinetoRelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegLinetoRelPrototype(globalObject, JSSVGPathSegLinetoRelPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
