...
const ClassInfo JSNavigator::s_info = { "Navigator", &DOMObjectWithGlobalPointer::s_info, &JSNavigatorTable, 0 };
...
{
    return new (exec) JSNavigatorPrototype(globalObject, JSNavigatorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
