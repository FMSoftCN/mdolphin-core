...
const ClassInfo JSHistory::s_info = { "History", &DOMObjectWithGlobalPointer::s_info, &JSHistoryTable, 0 };
...
{
    return new (exec) JSHistoryPrototype(globalObject, JSHistoryPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
