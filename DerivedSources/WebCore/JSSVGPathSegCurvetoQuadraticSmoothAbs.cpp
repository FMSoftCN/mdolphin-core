...
public:
    JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor::JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype(globalObject, JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
