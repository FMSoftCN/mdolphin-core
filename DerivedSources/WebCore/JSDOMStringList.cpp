...
public:
    JSDOMStringListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDOMStringListConstructor::JSDOMStringListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMStringListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueDescriptor<JSDOMStringListConstructor, DOMObject>(exec, &JSDOMStringListConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDOMStringList::s_info = { "DOMStringList", &DOMObjectWithGlobalPointer::s_info, &JSDOMStringListTable, 0 };

JSDOMStringList::JSDOMStringList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DOMStringList> impl)
...
{
    return new (exec) JSDOMStringListPrototype(globalObject, JSDOMStringListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DOMStringList* object)
{
    return getDOMObjectWrapper<JSDOMStringList>(exec, globalObject, object);
}
