...
public:
    JSJavaScriptAudioNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSJavaScriptAudioNodeConstructor::JSJavaScriptAudioNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSJavaScriptAudioNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSJavaScriptAudioNodeConstructor, DOMObject>(exec, &JSJavaScriptAudioNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSJavaScriptAudioNodeConstructor, DOMObject>(exec, &JSJavaScriptAudioNodeConstructorTable, this, propertyName, descriptor);
}
...
JSJavaScriptAudioNode::JSJavaScriptAudioNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<JavaScriptAudioNode> impl)
...
{
    return new (exec) JSJavaScriptAudioNodePrototype(globalObject, JSJavaScriptAudioNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
...
{
    UNUSED_PARAM(exec);
    JavaScriptAudioNode* imp = static_cast<JavaScriptAudioNode*>(static_cast<JSJavaScriptAudioNode*>(thisObject)->impl());
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, JavaScriptAudioNode* object)
{
    return getDOMObjectWrapper<JSJavaScriptAudioNode>(exec, globalObject, object);
}
