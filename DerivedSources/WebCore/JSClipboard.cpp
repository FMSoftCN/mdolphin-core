...
JSClipboardConstructor::JSClipboardConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSClipboardConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSClipboard::s_info = { "Clipboard", &DOMObjectWithGlobalPointer::s_info, &JSClipboardTable, 0 };
...
{
    return new (exec) JSClipboardPrototype(globalObject, JSClipboardPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
