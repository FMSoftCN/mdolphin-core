...
public:
    JSDelayNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDelayNodeConstructor::JSDelayNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDelayNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDelayNodeConstructor, DOMObject>(exec, &JSDelayNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDelayNodeConstructor, DOMObject>(exec, &JSDelayNodeConstructorTable, this, propertyName, descriptor);
}
...
JSDelayNode::JSDelayNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DelayNode> impl)
...
{
    return new (exec) JSDelayNodePrototype(globalObject, JSDelayNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DelayNode* object)
{
    return getDOMObjectWrapper<JSDelayNode>(exec, globalObject, object);
}
