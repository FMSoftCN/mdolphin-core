...
JSRGBColorConstructor::JSRGBColorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSRGBColorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSRGBColor::s_info = { "RGBColor", &DOMObjectWithGlobalPointer::s_info, &JSRGBColorTable, 0 };
...
{
    return new (exec) JSRGBColorPrototype(globalObject, JSRGBColorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
