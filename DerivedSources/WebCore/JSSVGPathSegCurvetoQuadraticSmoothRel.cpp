...
public:
    JSSVGPathSegCurvetoQuadraticSmoothRelConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegCurvetoQuadraticSmoothRelConstructor::JSSVGPathSegCurvetoQuadraticSmoothRelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegCurvetoQuadraticSmoothRelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegCurvetoQuadraticSmoothRelPrototype(globalObject, JSSVGPathSegCurvetoQuadraticSmoothRelPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
