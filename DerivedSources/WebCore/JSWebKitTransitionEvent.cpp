...
public:
    JSWebKitTransitionEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebKitTransitionEventConstructor::JSWebKitTransitionEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitTransitionEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSWebKitTransitionEventPrototype(globalObject, JSWebKitTransitionEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
