...
public:
    JSLowPass2FilterNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSLowPass2FilterNodeConstructor::JSLowPass2FilterNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSLowPass2FilterNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSLowPass2FilterNodeConstructor, DOMObject>(exec, &JSLowPass2FilterNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSLowPass2FilterNodeConstructor, DOMObject>(exec, &JSLowPass2FilterNodeConstructorTable, this, propertyName, descriptor);
}
...
JSLowPass2FilterNode::JSLowPass2FilterNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<LowPass2FilterNode> impl)
...
{
    return new (exec) JSLowPass2FilterNodePrototype(globalObject, JSLowPass2FilterNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, LowPass2FilterNode* object)
{
    return getDOMObjectWrapper<JSLowPass2FilterNode>(exec, globalObject, object);
}
