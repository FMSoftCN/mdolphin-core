...
public:
    JSSVGAnimatedStringConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedStringConstructor::JSSVGAnimatedStringConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedStringConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedString::s_info = { "SVGAnimatedString", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedStringTable, 0 };
...
{
    return new (exec) JSSVGAnimatedStringPrototype(globalObject, JSSVGAnimatedStringPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedString* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedString>(exec, globalObject, object);
}
