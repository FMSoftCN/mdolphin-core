...
const ClassInfo JSPerformance::s_info = { "Performance", &DOMObjectWithGlobalPointer::s_info, &JSPerformanceTable, 0 };
...
{
    return new (exec) JSPerformancePrototype(globalObject, JSPerformancePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
