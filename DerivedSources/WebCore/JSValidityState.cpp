...
const ClassInfo JSValidityState::s_info = { "ValidityState", &DOMObjectWithGlobalPointer::s_info, &JSValidityStateTable, 0 };
...
{
    return new (exec) JSValidityStatePrototype(globalObject, JSValidityStatePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
