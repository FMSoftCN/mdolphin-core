...
public:
    JSSVGFEGaussianBlurElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEGaussianBlurElementConstructor::JSSVGFEGaussianBlurElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEGaussianBlurElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEGaussianBlurElementPrototype(globalObject, JSSVGFEGaussianBlurElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
