...
public:
    JSStyleMediaConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSStyleMediaConstructor::JSStyleMediaConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSStyleMediaConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSStyleMedia::s_info = { "StyleMedia", &DOMObjectWithGlobalPointer::s_info, &JSStyleMediaTable, 0 };
...
{
    return new (exec) JSStyleMediaPrototype(globalObject, JSStyleMediaPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
