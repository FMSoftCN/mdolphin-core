...
public:
    JSHTMLTableCaptionElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLTableCaptionElementConstructor::JSHTMLTableCaptionElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLTableCaptionElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLTableCaptionElementPrototype(globalObject, JSHTMLTableCaptionElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
