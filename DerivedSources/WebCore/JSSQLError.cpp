...
const ClassInfo JSSQLError::s_info = { "SQLError", &DOMObjectWithGlobalPointer::s_info, 0, getJSSQLErrorTable };
...
{
    return new (exec) JSSQLErrorPrototype(globalObject, JSSQLErrorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
