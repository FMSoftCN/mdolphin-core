...
JSC::EncodedJSValue JSC_HOST_CALL jsWorkerContextPrototypeFunctionRequestFileSystem(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsWorkerContextPrototypeFunctionRequestFileSystemSync(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsWorkerContextPrototypeFunctionResolveLocalFileSystemURL(JSC::ExecState*);
JSC::EncodedJSValue JSC_HOST_CALL jsWorkerContextPrototypeFunctionResolveLocalFileSystemSyncURL(JSC::ExecState*);
// Attributes
...
JSC::JSValue jsWorkerContextBlobBuilderConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSWorkerContextBlobBuilderConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
...
JSC::JSValue jsWorkerContextFlagsConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSWorkerContextFlagsConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsWorkerContextFileErrorConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSWorkerContextFileErrorConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsWorkerContextFileExceptionConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
...
JSC::JSValue jsWorkerContextTEMPORARY(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsWorkerContextPERSISTENT(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
