...
JSSVGMatrixConstructor::JSSVGMatrixConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGMatrixConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGMatrix::s_info = { "SVGMatrix", &DOMObjectWithGlobalPointer::s_info, &JSSVGMatrixTable, 0 };

JSSVGMatrix::JSSVGMatrix(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPropertyTearOff<SVGMatrix> > impl)
...
{
    return new (exec) JSSVGMatrixPrototype(globalObject, JSSVGMatrixPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPropertyTearOff<SVGMatrix> * object)
{
    return getDOMObjectWrapper<JSSVGMatrix, SVGPropertyTearOff<SVGMatrix> >(exec, globalObject, object);
}
