...
public:
    JSSVGPathSegConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegConstructor::JSSVGPathSegConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGPathSeg::s_info = { "SVGPathSeg", &DOMObjectWithGlobalPointer::s_info, &JSSVGPathSegTable, 0 };
...
{
    return new (exec) JSSVGPathSegPrototype(globalObject, JSSVGPathSegPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
