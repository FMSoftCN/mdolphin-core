...
public:
    JSHTMLInputElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLInputElementConstructor::JSHTMLInputElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLInputElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLInputElementPrototype(globalObject, JSHTMLInputElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
