...
JSDataViewConstructor::JSDataViewConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDataViewConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDataViewConstructor, DOMObject>(exec, &JSDataViewConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDataViewConstructor, DOMObject>(exec, &JSDataViewConstructorTable, this, propertyName, descriptor);
}
...
JSDataView::JSDataView(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DataView> impl)
...
{
    return new (exec) JSDataViewPrototype(globalObject, JSDataViewPrototype::createStructure(exec->globalData(), JSArrayBufferViewPrototype::self(exec, globalObject)));
}
