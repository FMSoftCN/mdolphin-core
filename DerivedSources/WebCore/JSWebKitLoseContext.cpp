...
const ClassInfo JSWebKitLoseContext::s_info = { "WebKitLoseContext", &DOMObjectWithGlobalPointer::s_info, 0, 0 };

JSWebKitLoseContext::JSWebKitLoseContext(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<WebKitLoseContext> impl)
...
{
    return new (exec) JSWebKitLoseContextPrototype(globalObject, JSWebKitLoseContextPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, WebKitLoseContext* object)
{
    return getDOMObjectWrapper<JSWebKitLoseContext>(exec, globalObject, object);
}
