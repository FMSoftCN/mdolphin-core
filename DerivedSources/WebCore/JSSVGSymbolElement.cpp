...
public:
    JSSVGSymbolElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGSymbolElementConstructor::JSSVGSymbolElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGSymbolElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGSymbolElementPrototype(globalObject, JSSVGSymbolElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
