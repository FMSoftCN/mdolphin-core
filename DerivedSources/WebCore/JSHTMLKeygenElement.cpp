...
public:
    JSHTMLKeygenElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLKeygenElementConstructor::JSHTMLKeygenElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLKeygenElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSHTMLKeygenElementConstructor, DOMObject>(exec, &JSHTMLKeygenElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHTMLKeygenElementConstructor, DOMObject>(exec, &JSHTMLKeygenElementConstructorTable, this, propertyName, descriptor);
}
...
JSHTMLKeygenElement::JSHTMLKeygenElement(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<HTMLKeygenElement> impl)
...
{
    return new (exec) JSHTMLKeygenElementPrototype(globalObject, JSHTMLKeygenElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
