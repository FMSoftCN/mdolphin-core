...
public:
    JSWebGLActiveInfoConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLActiveInfoConstructor::JSWebGLActiveInfoConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLActiveInfoConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLActiveInfoConstructor, DOMObject>(exec, &JSWebGLActiveInfoConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLActiveInfoConstructor, DOMObject>(exec, &JSWebGLActiveInfoConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLActiveInfo::s_info = { "WebGLActiveInfo", &DOMObjectWithGlobalPointer::s_info, &JSWebGLActiveInfoTable, 0 };
...
{
    return new (exec) JSWebGLActiveInfoPrototype(globalObject, JSWebGLActiveInfoPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
