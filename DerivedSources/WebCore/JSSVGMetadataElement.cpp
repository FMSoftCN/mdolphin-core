...
public:
    JSSVGMetadataElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGMetadataElementConstructor::JSSVGMetadataElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGMetadataElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGMetadataElementPrototype(globalObject, JSSVGMetadataElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
