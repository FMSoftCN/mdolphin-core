...
public:
    JSSVGAngleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAngleConstructor::JSSVGAngleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAngleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAngle::s_info = { "SVGAngle", &DOMObjectWithGlobalPointer::s_info, &JSSVGAngleTable, 0 };

JSSVGAngle::JSSVGAngle(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGPropertyTearOff<SVGAngle> > impl)
...
{
    return new (exec) JSSVGAnglePrototype(globalObject, JSSVGAnglePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGPropertyTearOff<SVGAngle> * object)
{
    return getDOMObjectWrapper<JSSVGAngle, SVGPropertyTearOff<SVGAngle> >(exec, globalObject, object);
}
