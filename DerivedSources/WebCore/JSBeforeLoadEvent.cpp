...
public:
    JSBeforeLoadEventConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSBeforeLoadEventConstructor::JSBeforeLoadEventConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSBeforeLoadEventConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSBeforeLoadEventPrototype(globalObject, JSBeforeLoadEventPrototype::createStructure(exec->globalData(), JSEventPrototype::self(exec, globalObject)));
}
