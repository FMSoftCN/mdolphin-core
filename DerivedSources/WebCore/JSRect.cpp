...
public:
    JSRectConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSRectConstructor::JSRectConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSRectConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSRect::s_info = { "Rect", &DOMObjectWithGlobalPointer::s_info, &JSRectTable, 0 };
...
{
    return new (exec) JSRectPrototype(globalObject, JSRectPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
