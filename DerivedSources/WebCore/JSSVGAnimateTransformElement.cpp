...
public:
    JSSVGAnimateTransformElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimateTransformElementConstructor::JSSVGAnimateTransformElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimateTransformElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGAnimateTransformElementPrototype(globalObject, JSSVGAnimateTransformElementPrototype::createStructure(exec->globalData(), JSSVGAnimationElementPrototype::self(exec, globalObject)));
}
