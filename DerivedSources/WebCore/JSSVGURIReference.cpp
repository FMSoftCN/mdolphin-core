...
const ClassInfo JSSVGURIReference::s_info = { "SVGURIReference", &DOMObjectWithGlobalPointer::s_info, &JSSVGURIReferenceTable, 0 };
...
{
    return new (exec) JSSVGURIReferencePrototype(globalObject, JSSVGURIReferencePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGURIReference* object)
{
    return getDOMObjectWrapper<JSSVGURIReference>(exec, globalObject, object);
}
