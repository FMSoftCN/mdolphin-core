...
public:
    JSHTMLMenuElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLMenuElementConstructor::JSHTMLMenuElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLMenuElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLMenuElementPrototype(globalObject, JSHTMLMenuElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
