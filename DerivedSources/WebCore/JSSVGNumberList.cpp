...
JSSVGNumberListConstructor::JSSVGNumberListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGNumberListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGNumberList::s_info = { "SVGNumberList", &DOMObjectWithGlobalPointer::s_info, &JSSVGNumberListTable, 0 };

JSSVGNumberList::JSSVGNumberList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGListPropertyTearOff<SVGNumberList> > impl)
...
{
    return new (exec) JSSVGNumberListPrototype(globalObject, JSSVGNumberListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGListPropertyTearOff<SVGNumberList> * object)
{
    return getDOMObjectWrapper<JSSVGNumberList>(exec, globalObject, object);
}
