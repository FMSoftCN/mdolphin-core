...
public:
    JSDirectoryEntry(NonNullPassRefPtr<JSC::Structure>, JSDOMGlobalObject*, PassRefPtr<DirectoryEntry>);
...
public:
    ...
    JSDirectoryEntryPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
