...
public:
    JSCSSStyleRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSStyleRuleConstructor::JSCSSStyleRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSStyleRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCSSStyleRulePrototype(globalObject, JSCSSStyleRulePrototype::createStructure(exec->globalData(), JSCSSRulePrototype::self(exec, globalObject)));
}
