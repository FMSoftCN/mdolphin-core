...
public:
    JSHTMLDataListElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLDataListElementConstructor::JSHTMLDataListElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLDataListElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLDataListElementPrototype(globalObject, JSHTMLDataListElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
