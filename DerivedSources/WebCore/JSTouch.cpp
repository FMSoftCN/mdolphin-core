...
static JSC_CONST_HASHTABLE HashTable JSTouchTable = { 32, 31, JSTouchTableValues, 0 };
...
JSTouchConstructor::JSTouchConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTouchConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSTouch::s_info = { "Touch", &DOMObjectWithGlobalPointer::s_info, &JSTouchTable, 0 };
...
{
    return new (exec) JSTouchPrototype(globalObject, JSTouchPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
