...
JSSVGTransformListConstructor::JSSVGTransformListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTransformListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGTransformList::s_info = { "SVGTransformList", &DOMObjectWithGlobalPointer::s_info, &JSSVGTransformListTable, 0 };

JSSVGTransformList::JSSVGTransformList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGTransformListPropertyTearOff > impl)
...
{
    return new (exec) JSSVGTransformListPrototype(globalObject, JSSVGTransformListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGTransformListPropertyTearOff * object)
{
    return getDOMObjectWrapper<JSSVGTransformList>(exec, globalObject, object);
}
