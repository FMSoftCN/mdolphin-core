...
public:
    JSSVGPointListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPointListConstructor::JSSVGPointListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPointListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGPointList::s_info = { "SVGPointList", &DOMObjectWithGlobalPointer::s_info, &JSSVGPointListTable, 0 };

JSSVGPointList::JSSVGPointList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGListPropertyTearOff<SVGPointList> > impl)
...
{
    return new (exec) JSSVGPointListPrototype(globalObject, JSSVGPointListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGListPropertyTearOff<SVGPointList> * object)
{
    return getDOMObjectWrapper<JSSVGPointList>(exec, globalObject, object);
}
