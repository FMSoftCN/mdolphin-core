...
JSClientRectListConstructor::JSClientRectListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSClientRectListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSClientRectList::s_info = { "ClientRectList", &DOMObjectWithGlobalPointer::s_info, &JSClientRectListTable, 0 };
...
{
    return new (exec) JSClientRectListPrototype(globalObject, JSClientRectListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
