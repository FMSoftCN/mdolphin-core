...
public:
    JSCSSRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSRuleConstructor::JSCSSRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCSSRule::s_info = { "CSSRule", &DOMObjectWithGlobalPointer::s_info, &JSCSSRuleTable, 0 };
...
{
    return new (exec) JSCSSRulePrototype(globalObject, JSCSSRulePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
