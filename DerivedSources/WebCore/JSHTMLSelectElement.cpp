...
public:
    JSHTMLSelectElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLSelectElementConstructor::JSHTMLSelectElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLSelectElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLSelectElementPrototype(globalObject, JSHTMLSelectElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
