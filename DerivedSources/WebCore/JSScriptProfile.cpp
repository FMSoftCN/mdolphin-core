...
const ClassInfo JSScriptProfile::s_info = { "ScriptProfile", &DOMObjectWithGlobalPointer::s_info, &JSScriptProfileTable, 0 };

JSScriptProfile::JSScriptProfile(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<ScriptProfile> impl)
...
{
    return new (exec) JSScriptProfilePrototype(globalObject, JSScriptProfilePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, ScriptProfile* object)
{
    return getDOMObjectWrapper<JSScriptProfile>(exec, globalObject, object);
}
