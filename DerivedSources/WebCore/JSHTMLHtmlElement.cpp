...
public:
    JSHTMLHtmlElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLHtmlElementConstructor::JSHTMLHtmlElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLHtmlElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLHtmlElementPrototype(globalObject, JSHTMLHtmlElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
