...
public:
    JSSVGAnimatedLengthConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedLengthConstructor::JSSVGAnimatedLengthConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedLengthConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedLength::s_info = { "SVGAnimatedLength", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedLengthTable, 0 };
...
{
    return new (exec) JSSVGAnimatedLengthPrototype(globalObject, JSSVGAnimatedLengthPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedLength* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedLength>(exec, globalObject, object);
}
