...
public:
    JSSVGFEFuncAElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEFuncAElementConstructor::JSSVGFEFuncAElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEFuncAElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEFuncAElementPrototype(globalObject, JSSVGFEFuncAElementPrototype::createStructure(exec->globalData(), JSSVGComponentTransferFunctionElementPrototype::self(exec, globalObject)));
}
