...
public:
    ...
    JSDOMFormDataPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
...
public:
    JSDOMFormDataConstructor(JSC::ExecState*, JSDOMGlobalObject*);
