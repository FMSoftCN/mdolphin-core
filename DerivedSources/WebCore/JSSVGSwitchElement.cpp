...
public:
    JSSVGSwitchElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGSwitchElementConstructor::JSSVGSwitchElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGSwitchElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGSwitchElementPrototype(globalObject, JSSVGSwitchElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
