...
public:
    JSInspectorFrontendHostConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSInspectorFrontendHostConstructor::JSInspectorFrontendHostConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSInspectorFrontendHostConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
static const HashTableValue JSInspectorFrontendHostPrototypeTableValues[20] =
{
...
#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSInspectorFrontendHostPrototypeTable = { 66, 63, JSInspectorFrontendHostPrototypeTableValues, 0 };
...
const ClassInfo JSInspectorFrontendHost::s_info = { "InspectorFrontendHost", &DOMObjectWithGlobalPointer::s_info, &JSInspectorFrontendHostTable, 0 };
...
{
    return new (exec) JSInspectorFrontendHostPrototype(globalObject, JSInspectorFrontendHostPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
