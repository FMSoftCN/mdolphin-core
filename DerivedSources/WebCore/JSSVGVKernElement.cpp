...
public:
    JSSVGVKernElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGVKernElementConstructor::JSSVGVKernElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGVKernElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSSVGVKernElementConstructor, DOMObject>(exec, &JSSVGVKernElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSSVGVKernElementConstructor, DOMObject>(exec, &JSSVGVKernElementConstructorTable, this, propertyName, descriptor);
}
...
JSSVGVKernElement::JSSVGVKernElement(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SVGVKernElement> impl)
...
{
    return new (exec) JSSVGVKernElementPrototype(globalObject, JSSVGVKernElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
