...
public:
    JSHTMLTableRowElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLTableRowElementConstructor::JSHTMLTableRowElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLTableRowElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLTableRowElementPrototype(globalObject, JSHTMLTableRowElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
