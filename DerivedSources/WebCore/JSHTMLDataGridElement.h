...
class JSHTMLDataGridElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLDataGridElementPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
