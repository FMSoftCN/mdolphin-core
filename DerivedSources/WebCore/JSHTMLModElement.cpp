...
public:
    JSHTMLModElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLModElementConstructor::JSHTMLModElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLModElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLModElementPrototype(globalObject, JSHTMLModElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
