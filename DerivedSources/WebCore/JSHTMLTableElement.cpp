...
public:
    JSHTMLTableElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLTableElementConstructor::JSHTMLTableElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLTableElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLTableElementPrototype(globalObject, JSHTMLTableElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
