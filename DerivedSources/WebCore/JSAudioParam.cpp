...
public:
    JSAudioParamConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioParamConstructor::JSAudioParamConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioParamConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioParamConstructor, DOMObject>(exec, &JSAudioParamConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioParamConstructor, DOMObject>(exec, &JSAudioParamConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSAudioParam::s_info = { "AudioParam", &DOMObjectWithGlobalPointer::s_info, &JSAudioParamTable, 0 };

JSAudioParam::JSAudioParam(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioParam> impl)
...
{
    return new (exec) JSAudioParamPrototype(globalObject, JSAudioParamPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioParam* object)
{
    return getDOMObjectWrapper<JSAudioParam>(exec, globalObject, object);
}
