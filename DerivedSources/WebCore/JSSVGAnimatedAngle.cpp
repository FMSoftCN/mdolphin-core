...
public:
    JSSVGAnimatedAngleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedAngleConstructor::JSSVGAnimatedAngleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedAngleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedAngle::s_info = { "SVGAnimatedAngle", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedAngleTable, 0 };
...
{
    return new (exec) JSSVGAnimatedAnglePrototype(globalObject, JSSVGAnimatedAnglePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedAngle* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedAngle>(exec, globalObject, object);
}
