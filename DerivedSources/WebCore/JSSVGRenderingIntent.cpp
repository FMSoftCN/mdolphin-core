...
public:
    JSSVGRenderingIntentConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGRenderingIntentConstructor::JSSVGRenderingIntentConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGRenderingIntentConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGRenderingIntent::s_info = { "SVGRenderingIntent", &DOMObjectWithGlobalPointer::s_info, &JSSVGRenderingIntentTable, 0 };
...
{
    return new (exec) JSSVGRenderingIntentPrototype(globalObject, JSSVGRenderingIntentPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGRenderingIntent* object)
{
    return getDOMObjectWrapper<JSSVGRenderingIntent>(exec, globalObject, object);
}
