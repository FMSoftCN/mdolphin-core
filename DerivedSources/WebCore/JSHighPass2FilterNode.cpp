...
public:
    JSHighPass2FilterNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHighPass2FilterNodeConstructor::JSHighPass2FilterNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHighPass2FilterNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSHighPass2FilterNodeConstructor, DOMObject>(exec, &JSHighPass2FilterNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHighPass2FilterNodeConstructor, DOMObject>(exec, &JSHighPass2FilterNodeConstructorTable, this, propertyName, descriptor);
}
...
JSHighPass2FilterNode::JSHighPass2FilterNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<HighPass2FilterNode> impl)
...
{
    return new (exec) JSHighPass2FilterNodePrototype(globalObject, JSHighPass2FilterNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, HighPass2FilterNode* object)
{
    return getDOMObjectWrapper<JSHighPass2FilterNode>(exec, globalObject, object);
}
