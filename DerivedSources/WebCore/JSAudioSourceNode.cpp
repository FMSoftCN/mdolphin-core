...
public:
    JSAudioSourceNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioSourceNodeConstructor::JSAudioSourceNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioSourceNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioSourceNodeConstructor, DOMObject>(exec, &JSAudioSourceNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioSourceNodeConstructor, DOMObject>(exec, &JSAudioSourceNodeConstructorTable, this, propertyName, descriptor);
}
...
JSAudioSourceNode::JSAudioSourceNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioSourceNode> impl)
...
{
    return new (exec) JSAudioSourceNodePrototype(globalObject, JSAudioSourceNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
