...
const ClassInfo JSSQLResultSet::s_info = { "SQLResultSet", &DOMObjectWithGlobalPointer::s_info, 0, getJSSQLResultSetTable };
...
{
    return new (exec) JSSQLResultSetPrototype(globalObject, JSSQLResultSetPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
