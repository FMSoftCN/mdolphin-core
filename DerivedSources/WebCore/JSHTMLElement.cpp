...
public:
    JSHTMLElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLElementConstructor::JSHTMLElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLElementPrototype(globalObject, JSHTMLElementPrototype::createStructure(exec->globalData(), JSElementPrototype::self(exec, globalObject)));
}
