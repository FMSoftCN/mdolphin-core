...
const ClassInfo JSHTMLDataGridElementConstructor::s_info = { "HTMLDataGridElementConstructor", &DOMConstructorObject::s_info, &JSHTMLDataGridElementConstructorTable, 0 };

JSHTMLDataGridElementConstructor::JSHTMLDataGridElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLDataGridElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
    ASSERT(inherits(&s_info));
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSHTMLDataGridElementPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}
...
const ClassInfo JSHTMLDataGridElementPrototype::s_info = { "HTMLDataGridElementPrototype", &JSC::JSObjectWithGlobalObject::s_info, &JSHTMLDataGridElementPrototypeTable, 0 };
...
{
    return new (exec) JSHTMLDataGridElementPrototype(globalObject, JSHTMLDataGridElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
