...
JSXSLTProcessorConstructor::JSXSLTProcessorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXSLTProcessorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXSLTProcessor::s_info = { "XSLTProcessor", &DOMObjectWithGlobalPointer::s_info, &JSXSLTProcessorTable, 0 };
...
{
    return new (exec) JSXSLTProcessorPrototype(globalObject, JSXSLTProcessorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
