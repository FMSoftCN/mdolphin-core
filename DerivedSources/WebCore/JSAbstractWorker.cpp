...
public:
    JSAbstractWorkerConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAbstractWorkerConstructor::JSAbstractWorkerConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAbstractWorkerConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSAbstractWorker::s_info = { "AbstractWorker", &DOMObjectWithGlobalPointer::s_info, &JSAbstractWorkerTable, 0 };
...
{
    return new (exec) JSAbstractWorkerPrototype(globalObject, JSAbstractWorkerPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
