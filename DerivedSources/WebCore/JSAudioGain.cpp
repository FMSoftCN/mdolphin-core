...
public:
    JSAudioGainConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioGainConstructor::JSAudioGainConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioGainConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioGainConstructor, DOMObject>(exec, &JSAudioGainConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioGainConstructor, DOMObject>(exec, &JSAudioGainConstructorTable, this, propertyName, descriptor);
}
...
JSAudioGain::JSAudioGain(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioGain> impl)
...
{
    return new (exec) JSAudioGainPrototype(globalObject, JSAudioGainPrototype::createStructure(exec->globalData(), JSAudioParamPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioGain* object)
{
    return getDOMObjectWrapper<JSAudioGain>(exec, globalObject, object);
}
