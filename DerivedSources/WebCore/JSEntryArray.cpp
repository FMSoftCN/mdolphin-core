...
public:
    JSEntryArrayConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSEntryArrayConstructor::JSEntryArrayConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEntryArrayConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSEntryArrayConstructor, DOMObject>(exec, &JSEntryArrayConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSEntryArrayConstructor, DOMObject>(exec, &JSEntryArrayConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSEntryArray::s_info = { "EntryArray", &DOMObjectWithGlobalPointer::s_info, 0, getJSEntryArrayTable };

JSEntryArray::JSEntryArray(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<EntryArray> impl)
...
{
    return new (exec) JSEntryArrayPrototype(globalObject, JSEntryArrayPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, EntryArray* object)
{
    return getDOMObjectWrapper<JSEntryArray>(exec, globalObject, object);
}
