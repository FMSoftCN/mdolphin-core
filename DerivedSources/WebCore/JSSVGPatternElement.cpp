...
public:
    JSSVGPatternElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPatternElementConstructor::JSSVGPatternElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPatternElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPatternElementPrototype(globalObject, JSSVGPatternElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
