...
public:
    JSHTMLHeadingElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLHeadingElementConstructor::JSHTMLHeadingElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLHeadingElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLHeadingElementPrototype(globalObject, JSHTMLHeadingElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
