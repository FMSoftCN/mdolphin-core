...
public:
    JSSVGFEFuncBElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEFuncBElementConstructor::JSSVGFEFuncBElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEFuncBElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEFuncBElementPrototype(globalObject, JSSVGFEFuncBElementPrototype::createStructure(exec->globalData(), JSSVGComponentTransferFunctionElementPrototype::self(exec, globalObject)));
}
