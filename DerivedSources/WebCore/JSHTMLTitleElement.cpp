...
public:
    JSHTMLTitleElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLTitleElementConstructor::JSHTMLTitleElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLTitleElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLTitleElementPrototype(globalObject, JSHTMLTitleElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
