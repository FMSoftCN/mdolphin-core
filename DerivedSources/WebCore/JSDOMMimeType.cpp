...
JSDOMMimeTypeConstructor::JSDOMMimeTypeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMMimeTypeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSDOMMimeType::s_info = { "MimeType", &DOMObjectWithGlobalPointer::s_info, &JSDOMMimeTypeTable, 0 };
...
{
    return new (exec) JSDOMMimeTypePrototype(globalObject, JSDOMMimeTypePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
