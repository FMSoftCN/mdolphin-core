...
public:
    JSWebKitCSSTransformValueConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebKitCSSTransformValueConstructor::JSWebKitCSSTransformValueConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitCSSTransformValueConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSWebKitCSSTransformValuePrototype(globalObject, JSWebKitCSSTransformValuePrototype::createStructure(exec->globalData(), JSCSSValueListPrototype::self(exec, globalObject)));
}
