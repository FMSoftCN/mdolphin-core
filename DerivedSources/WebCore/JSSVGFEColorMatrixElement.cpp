...
public:
    JSSVGFEColorMatrixElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEColorMatrixElementConstructor::JSSVGFEColorMatrixElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEColorMatrixElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEColorMatrixElementPrototype(globalObject, JSSVGFEColorMatrixElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
