...
public:
    JSWebGLUniformLocationConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLUniformLocationConstructor::JSWebGLUniformLocationConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLUniformLocationConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLUniformLocationConstructor, DOMObject>(exec, &JSWebGLUniformLocationConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLUniformLocationConstructor, DOMObject>(exec, &JSWebGLUniformLocationConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLUniformLocation::s_info = { "WebGLUniformLocation", &DOMObjectWithGlobalPointer::s_info, &JSWebGLUniformLocationTable, 0 };
...
{
    return new (exec) JSWebGLUniformLocationPrototype(globalObject, JSWebGLUniformLocationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
