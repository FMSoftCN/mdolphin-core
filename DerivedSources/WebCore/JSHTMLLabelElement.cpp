...
public:
    JSHTMLLabelElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLLabelElementConstructor::JSHTMLLabelElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLLabelElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLLabelElementPrototype(globalObject, JSHTMLLabelElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
