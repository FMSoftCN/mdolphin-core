...
public:
    JSFileConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSFileConstructor::JSFileConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSFilePrototype(globalObject, JSFilePrototype::createStructure(exec->globalData(), JSBlobPrototype::self(exec, globalObject)));
}
