...
public:
    JSFileWriterConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSFileWriterConstructor::JSFileWriterConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileWriterConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSFileWriterConstructor, DOMObject>(exec, &JSFileWriterConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSFileWriterConstructor, DOMObject>(exec, &JSFileWriterConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSFileWriter::s_info = { "FileWriter", &DOMObjectWithGlobalPointer::s_info, 0, getJSFileWriterTable };

JSFileWriter::JSFileWriter(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<FileWriter> impl)
...
void JSFileWriter::markChildren(MarkStack& markStack)
{
...
{
    return new (exec) JSFileWriterPrototype(globalObject, JSFileWriterPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
{
    UNUSED_PARAM(exec);
    FileWriter* imp = static_cast<FileWriter*>(static_cast<JSFileWriter*>(thisObject)->impl());
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, FileWriter* object)
{
    return getDOMObjectWrapper<JSFileWriter>(exec, globalObject, object);
}
