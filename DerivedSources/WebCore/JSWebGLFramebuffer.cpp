...
public:
    JSWebGLFramebufferConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLFramebufferConstructor::JSWebGLFramebufferConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLFramebufferConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLFramebufferConstructor, DOMObject>(exec, &JSWebGLFramebufferConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLFramebufferConstructor, DOMObject>(exec, &JSWebGLFramebufferConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLFramebuffer::s_info = { "WebGLFramebuffer", &DOMObjectWithGlobalPointer::s_info, &JSWebGLFramebufferTable, 0 };
...
{
    return new (exec) JSWebGLFramebufferPrototype(globalObject, JSWebGLFramebufferPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
