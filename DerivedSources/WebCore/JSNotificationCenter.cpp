...
const ClassInfo JSNotificationCenter::s_info = { "NotificationCenter", &DOMObjectWithGlobalPointer::s_info, 0, 0 };
...
{
    return new (exec) JSNotificationCenterPrototype(globalObject, JSNotificationCenterPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
