...
public:
    JSDirectoryEntrySyncConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDirectoryEntrySyncConstructor::JSDirectoryEntrySyncConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDirectoryEntrySyncConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDirectoryEntrySyncConstructor, DOMObject>(exec, &JSDirectoryEntrySyncConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDirectoryEntrySyncConstructor, DOMObject>(exec, &JSDirectoryEntrySyncConstructorTable, this, propertyName, descriptor);
}
...
JSDirectoryEntrySync::JSDirectoryEntrySync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DirectoryEntrySync> impl)
...
{
    return new (exec) JSDirectoryEntrySyncPrototype(globalObject, JSDirectoryEntrySyncPrototype::createStructure(exec->globalData(), JSEntrySyncPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DirectoryEntrySync* object)
{
    return getDOMObjectWrapper<JSDirectoryEntrySync>(exec, globalObject, object);
}
