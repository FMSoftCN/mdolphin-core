...
public:
    JSHTMLLegendElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLLegendElementConstructor::JSHTMLLegendElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLLegendElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLLegendElementPrototype(globalObject, JSHTMLLegendElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
