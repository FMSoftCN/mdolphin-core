...
public:
    JSSVGElementInstanceListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGElementInstanceListConstructor::JSSVGElementInstanceListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGElementInstanceListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGElementInstanceList::s_info = { "SVGElementInstanceList", &DOMObjectWithGlobalPointer::s_info, &JSSVGElementInstanceListTable, 0 };
...
{
    return new (exec) JSSVGElementInstanceListPrototype(globalObject, JSSVGElementInstanceListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
