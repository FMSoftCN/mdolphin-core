...
public:
    JSSVGEllipseElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGEllipseElementConstructor::JSSVGEllipseElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGEllipseElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGEllipseElementPrototype(globalObject, JSSVGEllipseElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
