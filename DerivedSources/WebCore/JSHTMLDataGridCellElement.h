...
class JSHTMLDataGridCellElementPrototype : public JSC::JSObjectWithGlobalObject {
...
public:
    ...
    JSHTMLDataGridCellElementPrototype(JSC::JSGlobalObject* globalObject, NonNullPassRefPtr<JSC::Structure> structure) : JSC::JSObjectWithGlobalObject(globalObject, structure) { }
protected:
