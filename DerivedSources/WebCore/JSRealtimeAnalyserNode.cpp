...
public:
    JSRealtimeAnalyserNodeConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSRealtimeAnalyserNodeConstructor::JSRealtimeAnalyserNodeConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSRealtimeAnalyserNodeConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSRealtimeAnalyserNodeConstructor, DOMObject>(exec, &JSRealtimeAnalyserNodeConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSRealtimeAnalyserNodeConstructor, DOMObject>(exec, &JSRealtimeAnalyserNodeConstructorTable, this, propertyName, descriptor);
}
...
JSRealtimeAnalyserNode::JSRealtimeAnalyserNode(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<RealtimeAnalyserNode> impl)
...
{
    return new (exec) JSRealtimeAnalyserNodePrototype(globalObject, JSRealtimeAnalyserNodePrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, RealtimeAnalyserNode* object)
{
    return getDOMObjectWrapper<JSRealtimeAnalyserNode>(exec, globalObject, object);
}
