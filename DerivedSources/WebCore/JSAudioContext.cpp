...
JSAudioContextConstructor::JSAudioContextConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioContextConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioContextConstructor, DOMObject>(exec, &JSAudioContextConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioContextConstructor, DOMObject>(exec, &JSAudioContextConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSAudioContext::s_info = { "AudioContext", &DOMObjectWithGlobalPointer::s_info, &JSAudioContextTable, 0 };

JSAudioContext::JSAudioContext(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioContext> impl)
...
{
    return new (exec) JSAudioContextPrototype(globalObject, JSAudioContextPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
{
    UNUSED_PARAM(exec);
    AudioContext* imp = static_cast<AudioContext*>(static_cast<JSAudioContext*>(thisObject)->impl());
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, AudioContext* object)
{
    return getDOMObjectWrapper<JSAudioContext>(exec, globalObject, object);
}
