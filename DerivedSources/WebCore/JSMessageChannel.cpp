...
JSMessageChannelConstructor::JSMessageChannelConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSMessageChannelConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSMessageChannel::s_info = { "MessageChannel", &DOMObjectWithGlobalPointer::s_info, 0, getJSMessageChannelTable };
...
{
    return new (exec) JSMessageChannelPrototype(globalObject, JSMessageChannelPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
