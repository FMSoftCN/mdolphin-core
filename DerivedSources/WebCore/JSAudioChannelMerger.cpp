...
public:
    JSAudioChannelMergerConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioChannelMergerConstructor::JSAudioChannelMergerConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioChannelMergerConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioChannelMergerConstructor, DOMObject>(exec, &JSAudioChannelMergerConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioChannelMergerConstructor, DOMObject>(exec, &JSAudioChannelMergerConstructorTable, this, propertyName, descriptor);
}
...
JSAudioChannelMerger::JSAudioChannelMerger(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioChannelMerger> impl)
...
{
    return new (exec) JSAudioChannelMergerPrototype(globalObject, JSAudioChannelMergerPrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
