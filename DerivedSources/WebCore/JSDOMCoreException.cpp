...
public:
    JSDOMCoreExceptionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDOMCoreExceptionConstructor::JSDOMCoreExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMCoreExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSDOMCoreException::s_info = { "DOMException", &DOMObjectWithGlobalPointer::s_info, 0, getJSDOMCoreExceptionTable };
...
{
    return new (exec) JSDOMCoreExceptionPrototype(globalObject, JSDOMCoreExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
