...
public:
    JSDocumentFragmentConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDocumentFragmentConstructor::JSDocumentFragmentConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDocumentFragmentConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSDocumentFragmentPrototype(globalObject, JSDocumentFragmentPrototype::createStructure(exec->globalData(), JSNodePrototype::self(exec, globalObject)));
}
