...
public:
    JSNamedNodeMapConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSNamedNodeMapConstructor::JSNamedNodeMapConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSNamedNodeMapConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSNamedNodeMap::s_info = { "NamedNodeMap", &DOMObjectWithGlobalPointer::s_info, &JSNamedNodeMapTable, 0 };
...
{
    return new (exec) JSNamedNodeMapPrototype(globalObject, JSNamedNodeMapPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
