...
JSDOMPluginArrayConstructor::JSDOMPluginArrayConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMPluginArrayConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSDOMPluginArray::s_info = { "PluginArray", &DOMObjectWithGlobalPointer::s_info, &JSDOMPluginArrayTable, 0 };
...
{
    return new (exec) JSDOMPluginArrayPrototype(globalObject, JSDOMPluginArrayPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
