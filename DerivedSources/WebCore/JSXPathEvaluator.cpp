...
public:
    JSXPathEvaluatorConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSXPathEvaluatorConstructor::JSXPathEvaluatorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXPathEvaluatorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXPathEvaluator::s_info = { "XPathEvaluator", &DOMObjectWithGlobalPointer::s_info, &JSXPathEvaluatorTable, 0 };
...
{
    return new (exec) JSXPathEvaluatorPrototype(globalObject, JSXPathEvaluatorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
