...
public:
    JSSQLExceptionConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSQLExceptionConstructor::JSSQLExceptionConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSQLExceptionConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSSQLExceptionConstructor, DOMObject>(exec, &JSSQLExceptionConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSSQLExceptionConstructor, DOMObject>(exec, &JSSQLExceptionConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSSQLException::s_info = { "SQLException", &DOMObjectWithGlobalPointer::s_info, 0, getJSSQLExceptionTable };

JSSQLException::JSSQLException(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<SQLException> impl)
...
{
    return new (exec) JSSQLExceptionPrototype(globalObject, JSSQLExceptionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SQLException* object)
{
    return getDOMObjectWrapper<JSSQLException>(exec, globalObject, object);
}
