...
public:
    JSWebGLShaderConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebGLShaderConstructor::JSWebGLShaderConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebGLShaderConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSWebGLShaderConstructor, DOMObject>(exec, &JSWebGLShaderConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSWebGLShaderConstructor, DOMObject>(exec, &JSWebGLShaderConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSWebGLShader::s_info = { "WebGLShader", &DOMObjectWithGlobalPointer::s_info, &JSWebGLShaderTable, 0 };
...
{
    return new (exec) JSWebGLShaderPrototype(globalObject, JSWebGLShaderPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
