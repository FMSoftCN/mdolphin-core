...
public:
    JSSVGTitleElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGTitleElementConstructor::JSSVGTitleElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTitleElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGTitleElementPrototype(globalObject, JSSVGTitleElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
