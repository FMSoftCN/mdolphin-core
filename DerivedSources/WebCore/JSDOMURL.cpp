...
const ClassInfo JSDOMURL::s_info = { "DOMURL", &DOMObjectWithGlobalPointer::s_info, 0, 0 };

JSDOMURL::JSDOMURL(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DOMURL> impl)
...
{
    return new (exec) JSDOMURLPrototype(globalObject, JSDOMURLPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DOMURL* object)
{
    return getDOMObjectWrapper<JSDOMURL>(exec, globalObject, object);
}
