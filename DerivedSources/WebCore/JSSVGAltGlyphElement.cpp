...
public:
    JSSVGAltGlyphElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAltGlyphElementConstructor::JSSVGAltGlyphElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAltGlyphElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGAltGlyphElementPrototype(globalObject, JSSVGAltGlyphElementPrototype::createStructure(exec->globalData(), JSSVGTextPositioningElementPrototype::self(exec, globalObject)));
}
