...
public:
    InspectorBackendDispatcher(InspectorFrontendChannel* inspectorFrontendChannel, InspectorApplicationCacheAgent* applicationCacheAgent, InspectorBrowserDebuggerAgent* browserDebuggerAgent, InspectorCSSAgent* cssAgent, InspectorConsoleAgent* consoleAgent, InspectorDOMAgent* domAgent, InspectorDOMStorageAgent* domStorageAgent, InspectorDatabaseAgent* databaseAgent, InspectorDebuggerAgent* debuggerAgent, InspectorAgent* inspectorAgent, InspectorResourceAgent* resourceAgent, InspectorPageAgent* pageAgent, InspectorProfilerAgent* profilerAgent, InspectorRuntimeAgent* runtimeAgent, InspectorTimelineAgent* timelineAgent)
        : m_inspectorFrontendChannel(inspectorFrontendChannel)
        , m_applicationCacheAgent(applicationCacheAgent)
        , m_browserDebuggerAgent(browserDebuggerAgent)
        , m_cssAgent(cssAgent)
    ...
    void reportProtocolError(const long callId, CommonErrorCode, const String& errorText) const;
    void reportProtocolError(const long callId, CommonErrorCode, PassRefPtr<InspectorArray> data) const;
    void dispatch(const String& message);
    static bool getCommandName(const String& message, String* result);

    static const char* Inspector_didEvaluateForTestInFrontendCmd;
    static const char* Page_addScriptToEvaluateOnLoadCmd;
    static const char* Page_removeAllScriptsToEvaluateOnLoadCmd;
    static const char* Page_reloadPageCmd;
    static const char* Page_openInInspectedWindowCmd;
    static const char* Page_setUserAgentOverrideCmd;
    ...
    static const char* Network_getCachedResourcesCmd;
    static const char* Network_getResourceContentCmd;
    ...
    static const char* DOM_setSearchingForNodeCmd;
    static const char* DOM_highlightDOMNodeCmd;
    static const char* DOM_hideDOMNodeHighlightCmd;
    ...
    static const char* BrowserDebugger_setDOMBreakpointCmd;
    static const char* BrowserDebugger_removeDOMBreakpointCmd;
    static const char* BrowserDebugger_setEventListenerBreakpointCmd;
    static const char* BrowserDebugger_removeEventListenerBreakpointCmd;
    static const char* BrowserDebugger_setXHRBreakpointCmd;
    static const char* BrowserDebugger_removeXHRBreakpointCmd;
...
private:
    ...
    void Inspector_didEvaluateForTestInFrontend(long callId, InspectorObject* requestMessageObject);
    ...
    void Page_reloadPage(long callId, InspectorObject* requestMessageObject);
    void Page_openInInspectedWindow(long callId, InspectorObject* requestMessageObject);
    void Page_setUserAgentOverride(long callId, InspectorObject* requestMessageObject);
    ...
    void Network_getCachedResources(long callId, InspectorObject* requestMessageObject);
    ...
    void DOM_setSearchingForNode(long callId, InspectorObject* requestMessageObject);
    void DOM_highlightDOMNode(long callId, InspectorObject* requestMessageObject);
    void DOM_hideDOMNodeHighlight(long callId, InspectorObject* requestMessageObject);
    ...
    void BrowserDebugger_setDOMBreakpoint(long callId, InspectorObject* requestMessageObject);
    void BrowserDebugger_removeDOMBreakpoint(long callId, InspectorObject* requestMessageObject);
    void BrowserDebugger_setEventListenerBreakpoint(long callId, InspectorObject* requestMessageObject);
    void BrowserDebugger_removeEventListenerBreakpoint(long callId, InspectorObject* requestMessageObject);
    void BrowserDebugger_setXHRBreakpoint(long callId, InspectorObject* requestMessageObject);
    void BrowserDebugger_removeXHRBreakpoint(long callId, InspectorObject* requestMessageObject);
    ...
    InspectorBrowserDebuggerAgent* m_browserDebuggerAgent;
