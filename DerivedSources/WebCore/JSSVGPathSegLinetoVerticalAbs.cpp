...
public:
    JSSVGPathSegLinetoVerticalAbsConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegLinetoVerticalAbsConstructor::JSSVGPathSegLinetoVerticalAbsConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegLinetoVerticalAbsConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegLinetoVerticalAbsPrototype(globalObject, JSSVGPathSegLinetoVerticalAbsPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
