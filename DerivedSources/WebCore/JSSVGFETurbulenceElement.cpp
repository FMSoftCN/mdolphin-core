...
public:
    JSSVGFETurbulenceElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFETurbulenceElementConstructor::JSSVGFETurbulenceElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFETurbulenceElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFETurbulenceElementPrototype(globalObject, JSSVGFETurbulenceElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
