...
public:
    JSSVGPaintConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPaintConstructor::JSSVGPaintConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPaintConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPaintPrototype(globalObject, JSSVGPaintPrototype::createStructure(exec->globalData(), JSSVGColorPrototype::self(exec, globalObject)));
}
