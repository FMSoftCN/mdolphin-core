...
public:
    JSHTMLMarqueeElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLMarqueeElementConstructor::JSHTMLMarqueeElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLMarqueeElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLMarqueeElementPrototype(globalObject, JSHTMLMarqueeElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
