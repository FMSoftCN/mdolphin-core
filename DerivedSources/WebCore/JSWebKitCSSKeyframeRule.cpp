...
public:
    JSWebKitCSSKeyframeRuleConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWebKitCSSKeyframeRuleConstructor::JSWebKitCSSKeyframeRuleConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitCSSKeyframeRuleConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSWebKitCSSKeyframeRulePrototype(globalObject, JSWebKitCSSKeyframeRulePrototype::createStructure(exec->globalData(), JSCSSRulePrototype::self(exec, globalObject)));
}
