...
public:
    JSHTMLMetaElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLMetaElementConstructor::JSHTMLMetaElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLMetaElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLMetaElementPrototype(globalObject, JSHTMLMetaElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
