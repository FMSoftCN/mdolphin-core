...
public:
    JSSVGFEPointLightElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEPointLightElementConstructor::JSSVGFEPointLightElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEPointLightElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEPointLightElementPrototype(globalObject, JSSVGFEPointLightElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
