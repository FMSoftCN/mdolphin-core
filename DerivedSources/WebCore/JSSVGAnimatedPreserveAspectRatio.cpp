...
public:
    JSSVGAnimatedPreserveAspectRatioConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedPreserveAspectRatioConstructor::JSSVGAnimatedPreserveAspectRatioConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedPreserveAspectRatioConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedPreserveAspectRatio::s_info = { "SVGAnimatedPreserveAspectRatio", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedPreserveAspectRatioTable, 0 };
...
{
    return new (exec) JSSVGAnimatedPreserveAspectRatioPrototype(globalObject, JSSVGAnimatedPreserveAspectRatioPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedPreserveAspectRatio* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedPreserveAspectRatio>(exec, globalObject, object);
}
