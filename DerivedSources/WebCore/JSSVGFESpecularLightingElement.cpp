...
public:
    JSSVGFESpecularLightingElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFESpecularLightingElementConstructor::JSSVGFESpecularLightingElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFESpecularLightingElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFESpecularLightingElementPrototype(globalObject, JSSVGFESpecularLightingElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
