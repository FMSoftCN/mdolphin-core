...
JSDOMStringMapConstructor::JSDOMStringMapConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDOMStringMapConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSDOMStringMap::s_info = { "DOMStringMap", &DOMObjectWithGlobalPointer::s_info, &JSDOMStringMapTable, 0 };
...
{
    return new (exec) JSDOMStringMapPrototype(globalObject, JSDOMStringMapPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
