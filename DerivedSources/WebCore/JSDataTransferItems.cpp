...
public:
    JSDataTransferItemsConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSDataTransferItemsConstructor::JSDataTransferItemsConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSDataTransferItemsConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSDataTransferItemsConstructor, DOMObject>(exec, &JSDataTransferItemsConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSDataTransferItemsConstructor, DOMObject>(exec, &JSDataTransferItemsConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSDataTransferItems::s_info = { "DataTransferItems", &DOMObjectWithGlobalPointer::s_info, &JSDataTransferItemsTable, 0 };

JSDataTransferItems::JSDataTransferItems(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<DataTransferItems> impl)
...
{
    return new (exec) JSDataTransferItemsPrototype(globalObject, JSDataTransferItemsPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, DataTransferItems* object)
{
    return getDOMObjectWrapper<JSDataTransferItems>(exec, globalObject, object);
}
