...
public:
    JSSVGStopElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGStopElementConstructor::JSSVGStopElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGStopElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGStopElementPrototype(globalObject, JSSVGStopElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
