...
public:
    JSCanvasRenderingContextConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCanvasRenderingContextConstructor::JSCanvasRenderingContextConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCanvasRenderingContextConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSCanvasRenderingContext::s_info = { "CanvasRenderingContext", &DOMObjectWithGlobalPointer::s_info, &JSCanvasRenderingContextTable, 0 };
...
{
    return new (exec) JSCanvasRenderingContextPrototype(globalObject, JSCanvasRenderingContextPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
