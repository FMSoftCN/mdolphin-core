...
public:
    JSSVGAnimatedTransformListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedTransformListConstructor::JSSVGAnimatedTransformListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedTransformListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedTransformList::s_info = { "SVGAnimatedTransformList", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedTransformListTable, 0 };
...
{
    return new (exec) JSSVGAnimatedTransformListPrototype(globalObject, JSSVGAnimatedTransformListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedTransformList* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedTransformList>(exec, globalObject, object);
}
