...
public:
    JSSVGPathSegLinetoHorizontalAbsConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPathSegLinetoHorizontalAbsConstructor::JSSVGPathSegLinetoHorizontalAbsConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPathSegLinetoHorizontalAbsConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPathSegLinetoHorizontalAbsPrototype(globalObject, JSSVGPathSegLinetoHorizontalAbsPrototype::createStructure(exec->globalData(), JSSVGPathSegPrototype::self(exec, globalObject)));
}
