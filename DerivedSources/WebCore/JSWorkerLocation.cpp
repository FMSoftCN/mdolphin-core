...
public:
    JSWorkerLocationConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSWorkerLocationConstructor::JSWorkerLocationConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWorkerLocationConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSWorkerLocation::s_info = { "WorkerLocation", &DOMObjectWithGlobalPointer::s_info, 0, getJSWorkerLocationTable };
...
{
    return new (exec) JSWorkerLocationPrototype(globalObject, JSWorkerLocationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
