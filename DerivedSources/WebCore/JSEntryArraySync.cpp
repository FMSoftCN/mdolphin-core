...
public:
    JSEntryArraySyncConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSEntryArraySyncConstructor::JSEntryArraySyncConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSEntryArraySyncConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSEntryArraySyncConstructor, DOMObject>(exec, &JSEntryArraySyncConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSEntryArraySyncConstructor, DOMObject>(exec, &JSEntryArraySyncConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSEntryArraySync::s_info = { "EntryArraySync", &DOMObjectWithGlobalPointer::s_info, 0, getJSEntryArraySyncTable };

JSEntryArraySync::JSEntryArraySync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<EntryArraySync> impl)
...
{
    return new (exec) JSEntryArraySyncPrototype(globalObject, JSEntryArraySyncPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, EntryArraySync* object)
{
    return getDOMObjectWrapper<JSEntryArraySync>(exec, globalObject, object);
}
