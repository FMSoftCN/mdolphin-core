...
public:
    JSSVGAnimatedLengthListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimatedLengthListConstructor::JSSVGAnimatedLengthListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimatedLengthListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSSVGAnimatedLengthList::s_info = { "SVGAnimatedLengthList", &DOMObjectWithGlobalPointer::s_info, &JSSVGAnimatedLengthListTable, 0 };
...
{
    return new (exec) JSSVGAnimatedLengthListPrototype(globalObject, JSSVGAnimatedLengthListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, SVGAnimatedLengthList* object)
{
    return getDOMObjectWrapper<JSSVGAnimatedLengthList>(exec, globalObject, object);
}
