...
JSWebKitPointConstructor::JSWebKitPointConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSWebKitPointConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSWebKitPoint::s_info = { "WebKitPoint", &DOMObjectWithGlobalPointer::s_info, &JSWebKitPointTable, 0 };
...
{
    return new (exec) JSWebKitPointPrototype(globalObject, JSWebKitPointPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
