...
const ClassInfo JSSQLTransaction::s_info = { "SQLTransaction", &DOMObjectWithGlobalPointer::s_info, 0, 0 };
...
{
    return new (exec) JSSQLTransactionPrototype(globalObject, JSSQLTransactionPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
