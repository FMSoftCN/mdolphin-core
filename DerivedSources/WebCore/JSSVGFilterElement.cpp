...
public:
    JSSVGFilterElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFilterElementConstructor::JSSVGFilterElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFilterElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFilterElementPrototype(globalObject, JSSVGFilterElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
