...
JSStorageConstructor::JSStorageConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSStorageConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSStorage::s_info = { "Storage", &DOMObjectWithGlobalPointer::s_info, &JSStorageTable, 0 };
...
{
    return new (exec) JSStoragePrototype(globalObject, JSStoragePrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
