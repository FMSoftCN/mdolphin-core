...
JSXMLHttpRequestConstructor::JSXMLHttpRequestConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXMLHttpRequestConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSXMLHttpRequestConstructor, DOMObject>(exec, &JSXMLHttpRequestConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSXMLHttpRequestConstructor, DOMObject>(exec, &JSXMLHttpRequestConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSXMLHttpRequest::s_info = { "XMLHttpRequest", &DOMObjectWithGlobalPointer::s_info, 0, getJSXMLHttpRequestTable };
...
{
    return new (exec) JSXMLHttpRequestPrototype(globalObject, JSXMLHttpRequestPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
