...
const ClassInfo JSCoordinates::s_info = { "Coordinates", &DOMObjectWithGlobalPointer::s_info, &JSCoordinatesTable, 0 };
...
{
    return new (exec) JSCoordinatesPrototype(globalObject, JSCoordinatesPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
