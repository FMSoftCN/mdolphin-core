...
public:
    JSHTMLParamElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLParamElementConstructor::JSHTMLParamElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLParamElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLParamElementPrototype(globalObject, JSHTMLParamElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
