...
public:
    JSHTMLMeterElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLMeterElementConstructor::JSHTMLMeterElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLMeterElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSHTMLMeterElementConstructor, DOMObject>(exec, &JSHTMLMeterElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHTMLMeterElementConstructor, DOMObject>(exec, &JSHTMLMeterElementConstructorTable, this, propertyName, descriptor);
}
...
JSHTMLMeterElement::JSHTMLMeterElement(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<HTMLMeterElement> impl)
...
{
    return new (exec) JSHTMLMeterElementPrototype(globalObject, JSHTMLMeterElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
