...
public:
    JSSVGRectElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGRectElementConstructor::JSSVGRectElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGRectElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGRectElementPrototype(globalObject, JSSVGRectElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
