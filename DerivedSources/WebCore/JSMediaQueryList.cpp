...
public:
    JSMediaQueryListConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSMediaQueryListConstructor::JSMediaQueryListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSMediaQueryListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSMediaQueryListConstructor, DOMObject>(exec, &JSMediaQueryListConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSMediaQueryListConstructor, DOMObject>(exec, &JSMediaQueryListConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSMediaQueryList::s_info = { "MediaQueryList", &DOMObjectWithGlobalPointer::s_info, &JSMediaQueryListTable, 0 };

JSMediaQueryList::JSMediaQueryList(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<MediaQueryList> impl)
...
{
    return new (exec) JSMediaQueryListPrototype(globalObject, JSMediaQueryListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, MediaQueryList* object)
{
    return getDOMObjectWrapper<JSMediaQueryList>(exec, globalObject, object);
}
