...
public:
    JSSVGComponentTransferFunctionElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGComponentTransferFunctionElementConstructor::JSSVGComponentTransferFunctionElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGComponentTransferFunctionElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGComponentTransferFunctionElementPrototype(globalObject, JSSVGComponentTransferFunctionElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
