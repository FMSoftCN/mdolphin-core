...
public:
    JSHTMLScriptElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLScriptElementConstructor::JSHTMLScriptElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLScriptElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSHTMLScriptElementPrototype(globalObject, JSHTMLScriptElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
