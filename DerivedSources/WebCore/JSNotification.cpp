...
const ClassInfo JSNotification::s_info = { "Notification", &DOMObjectWithGlobalPointer::s_info, &JSNotificationTable, 0 };
...
{
    return new (exec) JSNotificationPrototype(globalObject, JSNotificationPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
