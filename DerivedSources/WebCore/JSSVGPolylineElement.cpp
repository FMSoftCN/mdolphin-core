...
public:
    JSSVGPolylineElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGPolylineElementConstructor::JSSVGPolylineElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGPolylineElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGPolylineElementPrototype(globalObject, JSSVGPolylineElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
