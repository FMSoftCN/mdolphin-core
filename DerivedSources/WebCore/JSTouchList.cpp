...
JSTouchListConstructor::JSTouchListConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSTouchListConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSTouchList::s_info = { "TouchList", &DOMObjectWithGlobalPointer::s_info, &JSTouchListTable, 0 };
...
{
    return new (exec) JSTouchListPrototype(globalObject, JSTouchListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
