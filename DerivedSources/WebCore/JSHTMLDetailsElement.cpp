...
public:
    JSHTMLDetailsElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSHTMLDetailsElementConstructor::JSHTMLDetailsElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSHTMLDetailsElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSHTMLDetailsElementConstructor, DOMObject>(exec, &JSHTMLDetailsElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHTMLDetailsElementConstructor, DOMObject>(exec, &JSHTMLDetailsElementConstructorTable, this, propertyName, descriptor);
}
...
JSHTMLDetailsElement::JSHTMLDetailsElement(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<HTMLDetailsElement> impl)
...
{
    return new (exec) JSHTMLDetailsElementPrototype(globalObject, JSHTMLDetailsElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
