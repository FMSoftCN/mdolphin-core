...
const ClassInfo JSWebGLContextAttributes::s_info = { "WebGLContextAttributes", &DOMObjectWithGlobalPointer::s_info, &JSWebGLContextAttributesTable, 0 };
...
{
    return new (exec) JSWebGLContextAttributesPrototype(globalObject, JSWebGLContextAttributesPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
