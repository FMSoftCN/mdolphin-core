...
public:
    JSFileReaderSyncConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSFileReaderSyncConstructor::JSFileReaderSyncConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileReaderSyncConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSFileReaderSyncConstructor, DOMObject>(exec, &JSFileReaderSyncConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSFileReaderSyncConstructor, DOMObject>(exec, &JSFileReaderSyncConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSFileReaderSync::s_info = { "FileReaderSync", &DOMObjectWithGlobalPointer::s_info, 0, getJSFileReaderSyncTable };

JSFileReaderSync::JSFileReaderSync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<FileReaderSync> impl)
...
{
    return new (exec) JSFileReaderSyncPrototype(globalObject, JSFileReaderSyncPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, FileReaderSync* object)
{
    return getDOMObjectWrapper<JSFileReaderSync>(exec, globalObject, object);
}
