...
public:
    JSAudioChannelSplitterConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSAudioChannelSplitterConstructor::JSAudioChannelSplitterConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSAudioChannelSplitterConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSAudioChannelSplitterConstructor, DOMObject>(exec, &JSAudioChannelSplitterConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSAudioChannelSplitterConstructor, DOMObject>(exec, &JSAudioChannelSplitterConstructorTable, this, propertyName, descriptor);
}
...
JSAudioChannelSplitter::JSAudioChannelSplitter(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<AudioChannelSplitter> impl)
...
{
    return new (exec) JSAudioChannelSplitterPrototype(globalObject, JSAudioChannelSplitterPrototype::createStructure(exec->globalData(), JSAudioNodePrototype::self(exec, globalObject)));
}
