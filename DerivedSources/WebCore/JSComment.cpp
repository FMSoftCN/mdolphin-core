...
JSCommentConstructor::JSCommentConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCommentConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCommentPrototype(globalObject, JSCommentPrototype::createStructure(exec->globalData(), JSCharacterDataPrototype::self(exec, globalObject)));
}
