...
public:
    JSMediaErrorConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSMediaErrorConstructor::JSMediaErrorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSMediaErrorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSMediaError::s_info = { "MediaError", &DOMObjectWithGlobalPointer::s_info, &JSMediaErrorTable, 0 };
...
{
    return new (exec) JSMediaErrorPrototype(globalObject, JSMediaErrorPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
