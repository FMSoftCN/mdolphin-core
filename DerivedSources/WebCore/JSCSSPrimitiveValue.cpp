...
public:
    JSCSSPrimitiveValueConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSCSSPrimitiveValueConstructor::JSCSSPrimitiveValueConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSCSSPrimitiveValueConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSCSSPrimitiveValuePrototype(globalObject, JSCSSPrimitiveValuePrototype::createStructure(exec->globalData(), JSCSSValuePrototype::self(exec, globalObject)));
}
