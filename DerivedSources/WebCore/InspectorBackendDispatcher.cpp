...
const char* InspectorBackendDispatcher::Inspector_didEvaluateForTestInFrontendCmd = "Inspector.didEvaluateForTestInFrontend";
...
const char* InspectorBackendDispatcher::Page_reloadPageCmd = "Page.reloadPage";
const char* InspectorBackendDispatcher::Page_openInInspectedWindowCmd = "Page.openInInspectedWindow";
const char* InspectorBackendDispatcher::Page_setUserAgentOverrideCmd = "Page.setUserAgentOverride";
...
const char* InspectorBackendDispatcher::Network_getCachedResourcesCmd = "Network.getCachedResources";
const char* InspectorBackendDispatcher::Network_getResourceContentCmd = "Network.getResourceContent";
...
const char* InspectorBackendDispatcher::DOM_setSearchingForNodeCmd = "DOM.setSearchingForNode";
const char* InspectorBackendDispatcher::DOM_highlightDOMNodeCmd = "DOM.highlightDOMNode";
const char* InspectorBackendDispatcher::DOM_hideDOMNodeHighlightCmd = "DOM.hideDOMNodeHighlight";
...
const char* InspectorBackendDispatcher::BrowserDebugger_setDOMBreakpointCmd = "BrowserDebugger.setDOMBreakpoint";
const char* InspectorBackendDispatcher::BrowserDebugger_removeDOMBreakpointCmd = "BrowserDebugger.removeDOMBreakpoint";
const char* InspectorBackendDispatcher::BrowserDebugger_setEventListenerBreakpointCmd = "BrowserDebugger.setEventListenerBreakpoint";
const char* InspectorBackendDispatcher::BrowserDebugger_removeEventListenerBreakpointCmd = "BrowserDebugger.removeEventListenerBreakpoint";
const char* InspectorBackendDispatcher::BrowserDebugger_setXHRBreakpointCmd = "BrowserDebugger.setXHRBreakpoint";
const char* InspectorBackendDispatcher::BrowserDebugger_removeXHRBreakpointCmd = "BrowserDebugger.removeXHRBreakpoint";
...
void InspectorBackendDispatcher::Inspector_didEvaluateForTestInFrontend(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        int in_testCallId = getInt(paramsContainer.get(), "testCallId", false, protocolErrors.get());
        String in_jsonResult = getString(paramsContainer.get(), "jsonResult", false, protocolErrors.get());

        if (!protocolErrors->length())
            m_inspectorAgent->didEvaluateForTestInFrontend(&error, in_testCallId, in_jsonResult);
    } else
...
void InspectorBackendDispatcher::Page_reloadPage(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_pageAgent->reloadPage(&error, &in_ignoreCache);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Page_openInInspectedWindow(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_pageAgent->openInInspectedWindow(&error, in_url);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Page_setUserAgentOverride(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_pageAgent->setUserAgentOverride(&error, in_userAgent);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Runtime_evaluate(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_runtimeAgent->evaluate(&error, in_expression, in_objectGroup, &in_includeCommandLineAPI, &out_result);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Runtime_evaluateOn(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_runtimeAgent->evaluateOn(&error, in_objectId, in_expression, &out_result);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Network_getCachedResources(long callId, InspectorObject*)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (!protocolErrors->length())
        m_resourceAgent->getCachedResources(&error, &out_frameTree);
...
void InspectorBackendDispatcher::Network_getResourceContent(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_resourceAgent->getResourceContent(&error, in_frameId, in_url, &in_base64Encode, &out_content);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::DOM_setAttribute(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        int in_elementId = getInt(paramsContainer.get(), "elementId", false, protocolErrors.get());
        String in_name = getString(paramsContainer.get(), "name", false, protocolErrors.get());
        String in_value = getString(paramsContainer.get(), "value", false, protocolErrors.get());

        if (!protocolErrors->length())
            m_domAgent->setAttribute(&error, in_elementId, in_name, in_value);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::DOM_removeAttribute(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_domAgent->removeAttribute(&error, in_elementId, in_name);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::DOM_getEventListenersForNode(long callId, InspectorObject* requestMessageObject)
{
    ...
    RefPtr<InspectorArray> out_listenersArray = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_domAgent->getEventListenersForNode(&error, in_nodeId, &out_listenersArray);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
    ...
    RefPtr<InspectorObject> responseMessage = InspectorObject::create();
    RefPtr<InspectorObject> result = InspectorObject::create();
        result->setArray("listenersArray", out_listenersArray);
    responseMessage->setObject("result", result);
...
void InspectorBackendDispatcher::DOM_setOuterHTML(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_domAgent->setOuterHTML(&error, in_nodeId, in_outerHTML, &out_outNodeId);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::DOM_performSearch(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        String in_query = getString(paramsContainer.get(), "query", false, protocolErrors.get());
        bool in_runSynchronously = getBoolean(paramsContainer.get(), "runSynchronously", false, protocolErrors.get());
...
void InspectorBackendDispatcher::DOM_setSearchingForNode(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_domAgent->setSearchingForNode(&error, in_enabled, &out_newState);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
    ...
    RefPtr<InspectorObject> responseMessage = InspectorObject::create();
    RefPtr<InspectorObject> result = InspectorObject::create();
        result->setBoolean("newState", out_newState);
    responseMessage->setObject("result", result);
...
void InspectorBackendDispatcher::DOM_highlightDOMNode(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_domAgent->highlightDOMNode(&error, in_nodeId);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::DOM_hideDOMNodeHighlight(long callId, InspectorObject*)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (!protocolErrors->length())
        m_domAgent->hideDOMNodeHighlight(&error);
...
void InspectorBackendDispatcher::CSS_getStyleSheetText(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_cssAgent->getStyleSheetText(&error, in_styleSheetId, &out_url, &out_text);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::CSS_setStyleSheetText(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_cssAgent->setStyleSheetText(&error, in_styleSheetId, in_text, &out_success);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Debugger_editScriptSource(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        String in_newContent = getString(paramsContainer.get(), "newContent", false, protocolErrors.get());

        if (!protocolErrors->length())
            m_debuggerAgent->editScriptSource(&error, in_sourceID, in_newContent, &out_callFrames);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::Debugger_evaluateOnCallFrame(long callId, InspectorObject* requestMessageObject)
{
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_debuggerAgent->evaluateOnCallFrame(&error, in_callFrameId, in_expression, in_objectGroup, &in_includeCommandLineAPI, &out_result);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::BrowserDebugger_setDOMBreakpoint(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();

    if (!m_browserDebuggerAgent)
        protocolErrors->pushString("BrowserDebugger handler is not available.");
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_browserDebuggerAgent->setDOMBreakpoint(&error, in_nodeId, in_type);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::BrowserDebugger_removeDOMBreakpoint(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_browserDebuggerAgent->removeDOMBreakpoint(&error, in_nodeId, in_type);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::BrowserDebugger_setEventListenerBreakpoint(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_browserDebuggerAgent->setEventListenerBreakpoint(&error, in_eventName);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::BrowserDebugger_removeEventListenerBreakpoint(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_browserDebuggerAgent->removeEventListenerBreakpoint(&error, in_eventName);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::BrowserDebugger_setXHRBreakpoint(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_browserDebuggerAgent->setXHRBreakpoint(&error, in_url);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::BrowserDebugger_removeXHRBreakpoint(long callId, InspectorObject* requestMessageObject)
{
    RefPtr<InspectorArray> protocolErrors = InspectorArray::create();
    ...
    if (RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject("params")) {
        ...
        if (!protocolErrors->length())
            m_browserDebuggerAgent->removeXHRBreakpoint(&error, in_url);
    } else
        protocolErrors->pushString("'params' property with type 'object' was not found.");
...
void InspectorBackendDispatcher::dispatch(const String& message)
{
    ...
    if (dispatchMap.isEmpty()) {
        dispatchMap.add(Inspector_didEvaluateForTestInFrontendCmd, &InspectorBackendDispatcher::Inspector_didEvaluateForTestInFrontend);
        ...
        dispatchMap.add(Page_reloadPageCmd, &InspectorBackendDispatcher::Page_reloadPage);
        dispatchMap.add(Page_openInInspectedWindowCmd, &InspectorBackendDispatcher::Page_openInInspectedWindow);
        dispatchMap.add(Page_setUserAgentOverrideCmd, &InspectorBackendDispatcher::Page_setUserAgentOverride);
        ...
        dispatchMap.add(Network_getCachedResourcesCmd, &InspectorBackendDispatcher::Network_getCachedResources);
        dispatchMap.add(Network_getResourceContentCmd, &InspectorBackendDispatcher::Network_getResourceContent);
        ...
        dispatchMap.add(DOM_setSearchingForNodeCmd, &InspectorBackendDispatcher::DOM_setSearchingForNode);
        dispatchMap.add(DOM_highlightDOMNodeCmd, &InspectorBackendDispatcher::DOM_highlightDOMNode);
        dispatchMap.add(DOM_hideDOMNodeHighlightCmd, &InspectorBackendDispatcher::DOM_hideDOMNodeHighlight);
        ...
        dispatchMap.add(BrowserDebugger_setDOMBreakpointCmd, &InspectorBackendDispatcher::BrowserDebugger_setDOMBreakpoint);
        dispatchMap.add(BrowserDebugger_removeDOMBreakpointCmd, &InspectorBackendDispatcher::BrowserDebugger_removeDOMBreakpoint);
        dispatchMap.add(BrowserDebugger_setEventListenerBreakpointCmd, &InspectorBackendDispatcher::BrowserDebugger_setEventListenerBreakpoint);
        dispatchMap.add(BrowserDebugger_removeEventListenerBreakpointCmd, &InspectorBackendDispatcher::BrowserDebugger_removeEventListenerBreakpoint);
        dispatchMap.add(BrowserDebugger_setXHRBreakpointCmd, &InspectorBackendDispatcher::BrowserDebugger_setXHRBreakpoint);
        dispatchMap.add(BrowserDebugger_removeXHRBreakpointCmd, &InspectorBackendDispatcher::BrowserDebugger_removeXHRBreakpoint);
...
void InspectorBackendDispatcher::reportProtocolError(const long callId, CommonErrorCode code, const String& customText) const
{
...
void InspectorBackendDispatcher::reportProtocolError(const long callId, CommonErrorCode code, PassRefPtr<InspectorArray> data) const
{
