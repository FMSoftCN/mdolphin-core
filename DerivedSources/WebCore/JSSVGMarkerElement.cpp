...
public:
    JSSVGMarkerElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGMarkerElementConstructor::JSSVGMarkerElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGMarkerElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGMarkerElementPrototype(globalObject, JSSVGMarkerElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
