...
public:
    JSFileEntrySyncConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSFileEntrySyncConstructor::JSFileEntrySyncConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSFileEntrySyncConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return getStaticValueSlot<JSFileEntrySyncConstructor, DOMObject>(exec, &JSFileEntrySyncConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSFileEntrySyncConstructor, DOMObject>(exec, &JSFileEntrySyncConstructorTable, this, propertyName, descriptor);
}
...
JSFileEntrySync::JSFileEntrySync(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<FileEntrySync> impl)
...
{
    return new (exec) JSFileEntrySyncPrototype(globalObject, JSFileEntrySyncPrototype::createStructure(exec->globalData(), JSEntrySyncPrototype::self(exec, globalObject)));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, FileEntrySync* object)
{
    return getDOMObjectWrapper<JSFileEntrySync>(exec, globalObject, object);
}
