...
public:
    JSSVGTextPathElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGTextPathElementConstructor::JSSVGTextPathElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGTextPathElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGTextPathElementPrototype(globalObject, JSSVGTextPathElementPrototype::createStructure(exec->globalData(), JSSVGTextContentElementPrototype::self(exec, globalObject)));
}
