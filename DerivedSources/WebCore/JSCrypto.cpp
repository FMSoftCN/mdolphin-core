...
const ClassInfo JSCrypto::s_info = { "Crypto", &DOMObjectWithGlobalPointer::s_info, 0, 0 };

JSCrypto::JSCrypto(NonNullPassRefPtr<Structure> structure, JSDOMGlobalObject* globalObject, PassRefPtr<Crypto> impl)
...
{
    return new (exec) JSCryptoPrototype(globalObject, JSCryptoPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
...
JSC::JSValue toJS(JSC::ExecState* exec, JSDOMGlobalObject* globalObject, Crypto* object)
{
    return getDOMObjectWrapper<JSCrypto>(exec, globalObject, object);
}
