...
public:
    JSSVGDescElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGDescElementConstructor::JSSVGDescElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGDescElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGDescElementPrototype(globalObject, JSSVGDescElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
