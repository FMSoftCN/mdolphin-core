...
public:
    JSSVGFontFaceSrcElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFontFaceSrcElementConstructor::JSSVGFontFaceSrcElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFontFaceSrcElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFontFaceSrcElementPrototype(globalObject, JSSVGFontFaceSrcElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
