...
public:
    JSSVGAnimateColorElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGAnimateColorElementConstructor::JSSVGAnimateColorElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGAnimateColorElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGAnimateColorElementPrototype(globalObject, JSSVGAnimateColorElementPrototype::createStructure(exec->globalData(), JSSVGAnimationElementPrototype::self(exec, globalObject)));
}
