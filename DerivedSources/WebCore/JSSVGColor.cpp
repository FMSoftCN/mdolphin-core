...
public:
    JSSVGColorConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGColorConstructor::JSSVGColorConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGColorConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGColorPrototype(globalObject, JSSVGColorPrototype::createStructure(exec->globalData(), JSCSSValuePrototype::self(exec, globalObject)));
}
