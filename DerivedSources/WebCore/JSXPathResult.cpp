...
public:
    JSXPathResultConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSXPathResultConstructor::JSXPathResultConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSXPathResultConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
const ClassInfo JSXPathResult::s_info = { "XPathResult", &DOMObjectWithGlobalPointer::s_info, &JSXPathResultTable, 0 };
...
{
    return new (exec) JSXPathResultPrototype(globalObject, JSXPathResultPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
