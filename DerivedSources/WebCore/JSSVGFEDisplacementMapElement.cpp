...
public:
    JSSVGFEDisplacementMapElementConstructor(JSC::ExecState*, JSDOMGlobalObject*);
...
JSSVGFEDisplacementMapElementConstructor::JSSVGFEDisplacementMapElementConstructor(ExecState* exec, JSDOMGlobalObject* globalObject)
    : DOMConstructorObject(JSSVGFEDisplacementMapElementConstructor::createStructure(globalObject->globalData(), globalObject->objectPrototype()), globalObject)
{
...
{
    return new (exec) JSSVGFEDisplacementMapElementPrototype(globalObject, JSSVGFEDisplacementMapElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
