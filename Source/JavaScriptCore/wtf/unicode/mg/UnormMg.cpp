/*
** $Id: UnormMg.cpp 123 2010-06-22 09:55:14Z xwyan $
**
** UnormMg.cpp: implements file for unicode.
**
...
UBool u_growBufferFromStatic(void *context,
...
static inline UBool
nx_contains(const UnicodeSet *nx, USChar32 c) {
...
int32_t unorm_internalNormalize(UChar *dest, int32_t destCapacity,
                        const UChar *src, int32_t srcLength,
