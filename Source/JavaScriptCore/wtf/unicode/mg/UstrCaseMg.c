/*
** $Id: UstrCaseMg.c 123 2010-06-22 09:55:14Z xwyan $
**
** UstrCaseMg.c: implements file for unicode string functions.
**
...
int32_t ustr_foldCase(const UCaseProps *csp,
...
int32_t u_strcmpFold(const UChar *s1, int32_t length1,
