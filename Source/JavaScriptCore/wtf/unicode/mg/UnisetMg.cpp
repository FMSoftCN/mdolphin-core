/*
** $Id: UnisetMg.cpp 123 2010-06-22 09:55:14Z xwyan $
**
** UnisetMg.cpp: implements file for unicode hash.
**
...
void * UMemory::operator new(size_t size, const char* /*file*/, int /*line*/) {
    return UMemory::operator new(size);
}

void UMemory::operator delete(void* p, const char* /*file*/, int /*line*/) {
...
//         #elif defined (POSIX) && ICU_USE_THREADS == 1   //lock  malin
